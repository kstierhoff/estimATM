...
# Redefine 'cps.nasc' as the difference between NASC.350 and the old cps.nasc.
# This will effectively be considerend 'hake' NASC.
nasc$cps.nasc <- nasc$NASC.350 - nasc$cps.nasc
