...
%         hab = F(double(sst), log(double(chl)));
    ...
    set(hcb, 'Position', [0.80 0.1 0.0476 0.85])        % Colorbar size and position
...
%     set(hcb, 'YtickLabel', {'0%' '18%' '29%' '100%'})
    ...
    annotation(gcf, 'textbox', [0.845 0.06 0.049 0.054], ...
        'String', {'0'}, 'FitBoxToText', 'off', 'EdgeColor','none', ...
        'FontSize', 9);
    annotation(gcf, 'textbox', [0.845 0.213 0.049 0.054], ...
        'String', {'0.18'}, 'FitBoxToText', 'off', 'EdgeColor','none', ...
        'FontSize', 9);
    annotation(gcf, 'textbox', [0.845 0.306 0.049 0.054], ...
        'String', {'0.29'}, 'FitBoxToText', 'off', 'EdgeColor','none', ...
        'FontSize', 9);
    temp = annotation(gcf, 'textbox', [0.845 0.909 0.049 0.054], ...
...
% 
    ...
    text(.89, .45, 'Habitat probability', 'Rotation', 90)
