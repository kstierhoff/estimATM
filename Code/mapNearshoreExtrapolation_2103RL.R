...
nse.map.final <- ggdraw() +
  draw_plot(nse.map) +
  draw_plot(inset.map, 0.6, 0.6, 0.35, 0.35) 

# Save combined maps
ggsave(nse.map.final, 
       filename = paste(here("Figs/fig_biomass_dens_nse_"), i, "-", j, ".png",sep = ""),
       width  = (map.height*ns.aspect)*1.2, height = map.height*1.2)
...
nse.map.final <- ggdraw() +
  draw_plot(nse.map) +
  draw_plot(inset.map, 0.7, 0.65, 0.3, 0.3)

# Save combined maps
ggsave(nse.map.final,
       filename = paste(here("Figs/fig_biomass_dens_nse_"), i, "-", j, ".png",sep = ""),
       width  = (map.height*ns.aspect)*1, height = map.height*1)
...
nse.map.final <- ggdraw() +
  draw_plot(nse.map) +
  draw_plot(inset.map, 0.67, 0.61, 0.35, 0.35) 
