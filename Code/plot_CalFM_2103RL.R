...
cal.fm.38 <- extract_cal_fm(here("Data/Calibration/FM/CalibrationDataFile-D20210301-T191621_38kHz_FM.xml"),
                            vessel.name = "RL",
...
cal.fm.70 <- extract_cal_fm(here("Data/Calibration/FM/CalibrationDataFile-D20210301-T200558_70kHz_FM.xml"),
                             vessel.name = "RL",
                             survey.name = survey.name)$cal.res %>%  
  mutate(
    txdr = "ES70-7C",
...
cal.fm.120 <- extract_cal_fm(here("Data/Calibration/FM/CalibrationDataFile-D20210301-T203712_120 kHz_FM.xml"),
                             vessel.name = "RL",
                             survey.name = survey.name)$cal.res %>% 
  mutate(
    txdr = "ES120-7C",
...
cal.fm.200 <- extract_cal_fm(here("Data/Calibration/FM/CalibrationDataFile-D20210301-T211552_200kHz_FM.xml"),
                             vessel.name = "RL",
                             survey.name = survey.name)$cal.res %>% 
  mutate(
    txdr = "ES200-7C",
...
cal.fm.333 <- extract_cal_fm(here("Data/Calibration/FM/CalibrationDataFile-D20210301-T214451_333kHz_FM.xml"),
                             vessel.name = "RL",
                             survey.name = survey.name)$cal.res %>% 
  mutate(
    txdr = "ES333-7C",
