...
# Plot catch 
catch.bar.plot <- ggplot(catch.bar, aes(factor(haul), totalWeight, fill = group)) +
  ...
  scale_x_discrete(breaks = seq(0, 500, 2)) +
  theme(strip.background.x = element_blank(),
        strip.text.x       = element_text(face = "bold")) +
  labs(x = "Haul number", y = "Total  Weight (kg)")

ggsave(catch.bar.plot, file = here("Figs/fig_catch_weight_leg.png"),
       width = 12, height = 8)
