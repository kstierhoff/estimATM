...
# Run only selected lFops, usually T
...
(ref:trawl-species-proportions) Survey transects performed aboard _`r survey.vessel`_ overlaid with proportions of CPS species in trawl clusters (black points indicate trawl clusters with no CPS).
...
(ref:map-final-stratum-polygons) Final strata used to compute abundance and biomass for each species, total acoustic backscatter (black points), and acoustic backscatter attributed to each species (red points).
...
```{r interactive-data-explorer, echo=FALSE}
# Leaflet options
