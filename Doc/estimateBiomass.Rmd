...
nasc.density <- project_sf(nasc.density, crs.proj)

# 
# nasc.density2 <- ungroup(nasc.density)
# 
# nasc.density3 <- project_df(nasc.density, lat, long, crs.proj = crs.proj)

# project_df(nasc.density, crs.proj = crs.proj)
