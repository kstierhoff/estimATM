...
estimate.os       <- T # Estimate biomass in the offshore strata
estimate.ns       <- F # Estimate biomass in the nearshore strata
...
if (process.csv) {
  ...
  for (i in nasc.vessels) {
    ...
    if (!process.csv.all) {
      ...
      if (exists(here("Data/Backscatter", i, paste0("nasc_vessel_", i, "_RAW.rds")))) {
