...
download.hab      <- T # Download habitat map
...
if (save.figs) {
  ...
  trawl.pie.haul.wt <- base.map +
    ...
    # Plot panel label
    ggtitle("CPS Species Proportions in Trawl Hauls") +
    coord_sf(crs = crs.proj, # CA Albers Equal Area Projection
             xlim = c(map.bounds["xmin"], map.bounds["xmax"]), 
             ylim = c(map.bounds["ymin"], map.bounds["ymax"]))
  ...
  nasc.trawl.plot <- plot_grid(nasc.cluster.plot, trawl.pie.cluster.wt,
                                     nrow = 1, labels = c("a)", "b)"))
  ...
  ggsave(nasc.trawl.plot,
         filename = here("Figs/fig_nasc_trawl_proportion.png"),
         width = map.width*2, height = map.height)
  
  save(trawl.pie.cluster.wt,
...
if (save.figs) {
  ...
  nasc.cufes.trawl.plot      <- plot_grid(nasc.map, cufes.density.all, trawl.pie.cluster.wt,
                                     nrow = 1, labels = c("a)", "b)", "c)"))
  
  nasc.cufes.trawl.plot.long <- plot_grid(nasc.map, cufes.density.all, trawl.pie.cluster.wt,
...
if (save.figs) {
  ...
  acoustic.pie.plot.comp <- plot_grid(trawl.pie.cluster.wt, acoustic.pie.indiv, acoustic.pie.wg,
                                     nrow = 1, labels = c("a)", "b)", "c)"))
  ...
  save(acoustic.pie.indiv, acoustic.pie.wg, acoustic.pie.plot.comp,
