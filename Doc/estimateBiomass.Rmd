...
if (process.csv) {
  ...
  for (i in nasc.vessels) {
    ...
    if (!process.csv.all) {
      ...
      load(here("Data/Backscatter", i, paste0("nasc_vessel_", i, "_RAW.Rdata")))
    ...
    if (length(nasc.files) > 0) {
      # if (file.exists(here("Data/Backscatter", i, paste0("nasc_vessel_", i, "_RAW.Rdata")))) {
      #   
      # } else {
      #   nasc.vessel <- data.frame()  
      # }
      ...
      save(nasc.vessel, 
           file = here("Data/Backscatter", i, 
                       paste0("nasc_vessel_", i, "_RAW.Rdata")))
      ...
      if (rm.inshore[i]) {
        ...
        save(nasc.inshore, 
             file = here("Data/Backscatter", i, 
                         paste0("nasc_vessel_", i, "_inshore.Rdata")))
