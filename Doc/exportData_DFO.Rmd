...
pacman::p_load(tidyverse,reshape2,lubridate,knitr,maps,rnaturalearth,
               ...
               maptools,mapview,fs,DT,lwgeom,DBI,odbc,bookdown,sf,
...
if (file.exists(here("Data/UCTD/uctd_data.Rdata"))) {
  ...
  # Write CSV files
  write_csv(uctd.summ, file = here("Output/DFO/cast_summary_uctd.csv"))
  
  write_csv(all.uctd.casts, file = here("Output/DFO/cast_data_uctd.csv"))
}
```
...
if (file.exists(here("Data/CTD/ctd_data.Rdata"))) {
  ...
  # write table to CSV
  write_csv(all.ctd.hdr, file = here("Output/DFO/cast_summary_ctd.csv"))
  
  write_csv(all.ctd.casts, file = here("Output/DFO/cast_data_ctd.csv"))
}
```
