...
# Write CSV files
write_csv(catch, here("Output/MSR-Mexico/catch.csv"))
write_csv(haul, here("Output/MSR-Mexico/haul.csv"))
write_csv(lengths, here("Output/MSR-Mexico/lengths.csv"))
```
...
# Write CSV files
write_csv(nasc, here("Output/MSR-Mexico/backscatter_raw.csv"))
write_csv(nasc.plot, here("Output/MSR-Mexico/backscatter_summ.csv"))
```
...
write_csv(nav, here("Output/MSR-Mexico/nav_data.csv"))
```
