...
csv.paths <- c(dir_ls("//swc-storage3-s/AST3/SURVEYS/20190619_SAILDRONE_SummerCPS/PROCESSED/EV/CSV", 
                      regexp = "1907SD1045_*.*Final 38 kHz CPS.csv"),
               dir_ls("//swc-storage3-s/AST3/SURVEYS/20190619_SAILDRONE_SummerCPS/PROCESSED/EV/CSV", 
                      regexp = "1907SD1046_*.*Final 38 kHz CPS.csv"),
               dir_ls("//swc-storage3-s/AST3/SURVEYS/20190619_SAILDRONE_SummerCPS/PROCESSED/EV/CSV", 
                      regexp = "1907SD1047_*.*Final 38 kHz CPS.csv"))
```

```{r old-paths}
# csv.paths <- c(dir_ls("C:/SURVEY/1907RL/PROCESSED/EV/CSV/SAILDRONE", regexp = "1907SD1047_*.*Final 38 kHz CPS.csv"))
# csv.paths <- c(here("Data/Backscatter/LM/1907LM_138N_CPS-Final CPS.csv"),
               # here("Data/Backscatter/LM/1907LM_179N_CPS-Final CPS.csv"))
# csv.paths <- c(dir_ls("C:/SURVEY/1907RL/PROCESSED/EV/CSV/SAILDRONE", regexp = "1907SD1047_*.*Final 38 kHz CPS.csv"))
# csv.paths <- c(dir_ls("C:/SURVEY/1907RL/PROCESSED/EV/CSV/SAILDRONE", regexp = "*Final 38 kHz CPS.csv"))

# csv.paths <- c(dir_ls("C:/SURVEY/1907RL/PROCESSED/EV/CSV/SAILDRONE", regexp = "*Final 38 kHz CPS.csv"),
#                dir_ls("C:/SURVEY/1907RL/PROCESSED/EV/CSV/LASKER", regexp = "*O_CPS-Final 38 kHz CPS.csv"))

# csv.paths <- dir_ls("C:/SURVEY/1907RL/PROCESSED/EV/CSV/CARNAGE", regexp = "*.csv")
