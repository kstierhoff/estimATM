...
pacman::p_load(tidyverse,lubridate,here,sf,knitr,fs,leaflet,leaflet.extras,bookdown,
               leafem,mapview,htmltools,rnaturalearth,stplanr)
...
# Controls
process.csv <- F # Process CSV files, or just re-generate HTML/plots
...
```{r plot-backscatter,fig.cap='(ref:backscatter-map-cps)',out.width="100%"}
