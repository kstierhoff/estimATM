...
if (copy.files) {
  ...
  if (dir.exists(ctd.dir)) {
    ...
    ctd.hdr <- dir_ls(ctd.dir, regexp = ctd.hdr.pattern, recurse = TRUE) %>% 
      path_filter(regexp = "_processed", invert = TRUE)
...
```{r uctd-dZt-plot,out.width="100%",out.height="6in"}
if (exists("all.uctd.casts")) {
  if (length(all.uctd.casts) > 0) {
    if (save.figs) {
...
```{r uctd-depth-time-plot,out.width="100%",out.height="6in"}
if (exists("all.uctd.casts")) {
  if (length(all.uctd.casts) > 0) {
    if (save.figs) {
      # plot depth v time
...
```{r uctd-temp-depth-plot,out.width="100%",out.height="6in"}
if (exists("all.uctd.casts")) {
  if (length(all.uctd.casts) > 0) {
    if (save.figs) {
...
```{r uctd-sal-depth-plot,out.width="100%",out.height="6in"}
if (exists("all.uctd.casts")) {
  if (length(all.uctd.casts) > 0) {
    if (save.figs) {
...
```{r uctd-sv-depth-plot,out.width="100%",out.height="6in"}
if (exists("all.uctd.casts")) {
  if (length(all.uctd.casts) > 0) {
    if (save.figs) {
...
```{r uctd-chl-depth-plot,out.width="100%",out.height="6in"}
if (exists("all.uctd.casts")) {
  if (length(all.uctd.casts) > 0) {
...
```{r ctd-temp-depth-plot,out.width="100%",out.height="6in"}
if (exists("all.ctd.casts")) {
  if (length(all.ctd.casts) > 0) {
    if (save.figs) {
      # plot temperature v depth
...
```{r ctd-sal-depth-plot,out.width="100%",out.height="6in"}
if (exists("all.ctd.casts")) {
  if (length(all.ctd.casts) > 0) {
    if (save.figs) {
      # plot salinity v depth
...
```{r ctd-sv-depth-plot,out.width="100%",out.height="6in"}
if (exists("all.ctd.casts")) {
  if (length(all.ctd.casts) > 0) {
    if (save.figs) {
      # plot sound speed v depth
