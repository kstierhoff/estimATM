...
>>>>>>> 0a433698a96e65eeef7f63a115e6fe43ead304b8
...
shimadaCTD_raw <- read.csv("Q:/SURVEYS/20220627_LISA-MARIE_SummerCPS/DATA/CTD/NWFSC Cruise SH22-08/2022_all_ctd_meta.csv")
shimadaCTD<- st_as_sf(shimadaCTD_raw, coords = c("Longitude", "Latitude"), crs = 4326)
...
mapview(sd.lines, zcol = "saildrone") + 
  ...
  mapview(shimadaCTD, xcol = "Longitude", ycol = "Latitude")
```
