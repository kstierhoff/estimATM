...
```{r intersect-nav-final-sh,out.height='10in',out.width='100%'}
...
mapview(filter(tx.buffer, Type %in% type.list), zcol = "Type", alpha.regions = 0.1) + 
  mapview(sd.lines, zcol = "saildrone") +
  mapview(sd.int.final, zcol = "saildrone")# + mapview(shimadaCTD, xcol = "Longitude", ycol = "Latitude")
```

```{r intersect-nav-final,out.height='10in',out.width='100%',eval=FALSE}
