...
transects.sf <- st_read(here("Output/shapefiles/transects.shp"))
...
# Import LM sets
lm.sets <- read_csv(here("Data/Seine/lm_sets_20220804.csv")) %>% 
  st_as_sf(coords = c("long","lat"), crs = 4326)

# Read GPX file
lm.route <- tmaptools::read_GPX(here::here("Data/Nav", "LM-tracks.gpx"))
...
lm.map <- base.map + 
  ...
  geom_sf(data = lm.sets, shape = 21, fill = "white") +
...
lbc.path <- lbc.transects %>% 
  filter(between(Transect, 197,227))
