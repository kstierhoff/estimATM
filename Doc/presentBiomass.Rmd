...
- `r kableExtra::text_spec("Compulsory", color = "black")` (spaced 20 nmi) 
- `r kableExtra::text_spec("Adaptive", color = "red")` (spaced 10 nmi)

Expansion of core survey region

- `r kableExtra::text_spec("Nearshore", color = "magenta")` (spaced 5 nmi)
- `r kableExtra::text_spec("Offshore", color = "green")` (~100 nmi extensions, spaced 40 nmi)
