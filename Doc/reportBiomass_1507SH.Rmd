...
To quantify the potential bias in the estimated biomass of the central stock of Northern Anchovy, the 2016 estimate of abundance-at-length [@Stierhoff2020d] was projected back in time, in monthly steps, using  a growth model, monthly records of commercial landings, and a published estimate of natural mortality (see **Section \@ref(discussion-anchovy-biomass-central)**).  
