...
-   Create a Boolean echogram based on the SDs in the CPS range: SD($S_{V,\mathrm{200kHz}}$) \> -60 dB **[-65 dB in recent surveys]** $\bigcap$ SD($S_{V,\mathrm{120kHz}}$) \> -60 dB **[-65 dB in recent surveys]**. Diffuse backscattering layers [@Zwolinski2010] have low standard deviations, whereas fish schools have high standard deviations [@Demer2009];
