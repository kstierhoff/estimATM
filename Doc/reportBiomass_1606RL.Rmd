...
To investigate the potential biomass of CPS in areas where _`r survey.vessel`_ could safely navigate, acoustically sampled biomass along the easternmost portions of transects were extrapolated to the 5-m isobath in the unsampled nearshore areas (**Appendix \@ref(appendix-nearshore-biomass)**).  
...
-   Average the noise-free $S_V$ echograms using non-overlapping 11-sample by 3-ping windows; <!-- -   Expand the averaged, noise-reduced $S_V$ echograms with a 7 pixel x 7 pixel dilation; -->
...
We thank the crew members of FSV *`r survey.vessel`*, as well as the scientists and technicians that participated in the sampling operations at sea. CPS-catch data were compiled by Bev Macewicz and CPS-egg data were compiled by Ed Weber. Finally, we thank **[LIST OF REVIEWERS]** for reviewing and improving this document.
