...
To estimate the biomass of CPS in offshore areas that are not routinely sampled, _`r survey.vessel`_ and two USVs sampled along 100 nmi-long extensions of compulsory transects spaced 80 nmi-apart between Florence, OR and San Diego. Those results are presented in **Appendix \@ref(appendix-biomass-os)**.  
