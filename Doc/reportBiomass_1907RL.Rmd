...
**[Describe offshore and nearshore sampling, and perhaps nearshore extrapolation.]**  
...
To estimate the biomass of CPS in shallow, nearshore areas where sampling by _`r survey.vessel`_ is unsafe, two fishing vessels (F/Vs _Lisa Marie_ and _Long Beach Carnage_) and one USVs sampled along 5 nmi-long transects spaced 5 nmi-apart along the mainland coast between Cape Flattery and San Diego, and around Santa Cruz and Santa Catalina Island in the Southern CA Bight (SCB) (**Appendix \@ref(appendix-biomass-ns)**).
...
**[CHECK WHY POINT ESTIMATE IS OUTSIDE THE CONFIDENCE INTERVALS!!]**
...
The potential habitat of the northern stock of Pacific Sardine did not extend into the Southern CA Bight at the time it was sampled (**Fig. \@ref(fig:sardine-potential-habitat)c,d**). Therefore, biomass estimated in that area was attributed to the southern stock of Pacific Sardine.  
...
## Nearshore sampling
### Fishing vessel sampling

**[Add Discussion of sampling from fishing vessels.]**


### Unmanned surface vehicle sampling

**[Update using information from this year.]**
...
# Offshore biomass estimates {#appendix-biomass-os}  
## Introduction {#appendix-biomass-os-introduction}  

To estimate CPS biomass in offshore waters not routinely sampled during CCE surveys, sampling was also conducted by _`r survey.vessel`_ and two USVs along ~100 nmi-long extensions of compulsory transects spaced ~80 nmi-apart between approximately Florence, OR and San Diego. 
...
(ref:os-biom-dens-anch-c) Biomass densities of central stock of Northern Anchovy (_Engraulis mordax_) in the offshore survey region. The blue numbers represent the locations of trawl clusters with at least one anchovy. The gray line represents the vessel track.
...
(ref:os-biom-dens-sar-n) Biomass densities of northern stock of Pacific Sardine (_Sardinops sagax_) in the offshore survey region. The blue numbers represent the locations of trawl clusters with at least one sardine. The gray line represents the vessel track.
...
(ref:os-biom-dens-sar-s) Biomass densities of southern stock of Pacific Sardine (_Sardinops sagax_) in the offshore survey region. The blue numbers represent the locations of trawl clusters with at least one sardine. The gray line represents the vessel track.
...
(ref:os-biom-dens-mack) Biomass densities of Pacific Mackerel (_Scomber japonicus_) in the offshore survey region. The blue numbers represent the locations of trawl clusters with at least one mackerel. The gray line represents the vessel track.
...
(ref:os-biom-dens-jack) Biomass densities of Jack Mackerel (_Trachurus symmetricus_) in the offshore survey region. The blue numbers represent the locations of trawl clusters with at least one mackerel. The gray line represents the vessel track.
...
# Nearshore biomass estimates {#appendix-biomass-ns}  
...
Biomass of the northern stock of Northern Anchovy in the nearshore area was `r prettyNum(be.all.ns$Biomass[be.all.ns$Species == 'Engraulis mordax' & be.all.ns$Stock == "Northern"],big.mark=",",digits=3)` t (CI~95%~ = `r prettyNum(be.all.ns$lower.ci.B[be.all.ns$Species == 'Engraulis mordax' & be.all.ns$Stock == "Northern"],big.mark=",",digits=3)` - `r prettyNum(be.all.ns$upper.ci.B[be.all.ns$Species == 'Engraulis mordax' & be.all.ns$Stock == "Northern"],big.mark=",",digits=3)` t, CV = `r prettyNum(be.all.ns$biomass.cv[be.all.ns$Species == 'Engraulis mordax' & be.all.ns$Stock == "Northern"],big.mark=",",digits=1)`%; **Table \@ref(tab:biomass-anch-n-ns)**, **Fig. \@ref(fig:ns-biom-dens-anch-n)**). **The stock was distributed between approximately Fort Bragg and San Diego.**  
...
(ref:ns-biom-dens-anch-n) Biomass densities of northern stock of Northern Anchovy (_Engraulis mordax_) in the nearshore survey region. The blue numbers represent the locations of trawl clusters with at least one anchovy. The gray line represents the vessel track.
...
(ref:ns-biom-dens-anch-c) Biomass densities of central stock of Northern Anchovy (_Engraulis mordax_) in the nearshore survey region. The blue numbers represent the locations of trawl clusters with at least one anchovy. The gray line represents the vessel track.
...
Biomass of the northern stock of Pacific Sardine in the nearshore area was `r prettyNum(be.all.ns$Biomass[be.all.ns$Species == 'Sardinops sagax' & be.all.ns$Stock == "Northern"],big.mark=",",digits=3)` t (CI~95%~ = `r prettyNum(be.all.ns$lower.ci.B[be.all.ns$Species == 'Sardinops sagax' & be.all.ns$Stock == "Northern"],big.mark=",",digits=3)` - `r prettyNum(be.all.ns$upper.ci.B[be.all.ns$Species == 'Sardinops sagax' & be.all.ns$Stock == "Northern"],big.mark=",",digits=3)` t, CV = `r prettyNum(be.all.ns$biomass.cv[be.all.ns$Species == 'Sardinops sagax' & be.all.ns$Stock == "Northern"],big.mark=",",digits=1)`%; **Table \@ref(tab:biomass-sar-n-ns)**, **Fig. \@ref(fig:ns-biom-dens-sar-n)**). **The stock was distributed between Newport and Pt. Conception.**  
...
(ref:ns-biom-dens-sar-n) Biomass densities of northern stock of Pacific Sardine (_Sardinops sagax_) in the nearshore survey region. The blue numbers represent the locations of trawl clusters with at least one sardine. The gray line represents the vessel track.
...
(ref:ns-biom-dens-sar-s) Biomass densities of southern stock of Pacific Sardine (_Sardinops sagax_) in the nearshore survey region. The blue numbers represent the locations of trawl clusters with at least one sardine. The gray line represents the vessel track.
...
(ref:ns-biom-dens-mack) Biomass densities of Pacific Mackerel (_Scomber japonicus_) in the nearshore survey region. The blue numbers represent the locations of trawl clusters with at least one mackerel. The gray line represents the vessel track.
...
(ref:ns-biom-dens-jack) Biomass densities of Jack Mackerel (_Trachurus symmetricus_) in the nearshore survey region. The blue numbers represent the locations of trawl clusters with at least one mackerel. The gray line represents the vessel track.
...
(ref:ns-biom-dens-her) Biomass densities of Pacific Herring (_Clupea pallasii_) in the nearshore survey region. The blue numbers represent the locations of trawl clusters with at least one herring. The gray line represents the vessel track.
...
```{r nearshore-estimation,fig.cap='(ref:nearshore-extrapolation)',out.height='5.35in',fig.pos='H', eval=T}
