...
<!-- `r prettyNum(biomass.comm.summ$biomass.total[biomass.comm.summ$year == 2014],big.mark=",",digits=3)` -->
<!-- `r prettyNum(biomass.comm.summ$biomass.total[biomass.comm.summ$year == 2015],big.mark=",",digits=3)` -->
