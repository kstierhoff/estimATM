...
To estimate the biomass of CPS in offshore areas that are not routinely sampled, _`r survey.vessel`_ and two USVs sampled along 100 nmi-long extensions of compulsory transects spaced 80 nmi-apart between Florence, OR and San Diego.

**[For each species and stock, add nearshore biomass estimates.]**
...
Results from the offshore sampling are presented in **Appendix \@ref(appendix-biomass-os)**.
...
**[Add survey statistics from nearshore survey vessels, Lisa Marie, Long Beach Carnage, and USV]**
