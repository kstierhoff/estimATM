...
The echosounders were calibrated while dockside by Saildrone, Inc. using the standard sphere technique with a WC38.1. The results were processed and derived by the SWFSC [@Renfree2019], and are presented in **Table \@ref(tab:cal-results-sd)**. 

Calibration parameters were estimated from dockside calibrations with a WC38.1 conducted by Saildrone, Inc. Beam model results (**Table \@ref(tab:cal-results-sd)**) were applied in Echoview during post-processing.
