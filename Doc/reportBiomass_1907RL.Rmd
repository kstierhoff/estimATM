...
output: 
  bookdown::pdf_document2:
    includes: 
      in_header: ../yaml/header_1807RL.tex
    toc: yes
    toc_depth: 3
    number_sections: yes
...
load(paste(here("Output/cal"), "/", survey.vessel.primary, "/", "cal_output_table.Rdata", sep = ""))
```  
...
<!-- The biomass of CPS was also estimated in an offshore stratum comprised of seven transects that extended west of the core sampling areas as part of the marine mammal and turtle sampling (**Appendix \@ref(appendix-offshore-biomass)**). -->
...
include_graphics(here("Images/fig_survey_region.png"))  
```  
...
if (survey.vessel.primary == "RL") {
  include_graphics(here("Images/fig_centerboard_config_RL.png"))
} else if (survey.vessel.primary == "SH") {
  include_graphics(here("Images/fig_centerboard_config_SH.png"))
}
```  
...
```{r cal-results-saildrone, results='asis'}
...
include_graphics(here("Images/fig_trawl_sampling.png"))  
```  
...
source(here("Code/length_conversions.R"))
```  
...
include_graphics(here("Figs/fig_nasc_cluster_trawl_prop_map.png"))
```  
...
include_graphics(here("Figs/fig_nasc_cufes_trawl_prop_map.png"))
```  
...
```{r nasc-saildrone, fig.cap='(ref:nasc-saildrone)',out.height='8in',fig.pos='H'}
# Insert Nasc Map - Saildrone only
...
# Insert biomass density plot for mackerel
...
# Insert disaggregated abundance plots for mackerel
