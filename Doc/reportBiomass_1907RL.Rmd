...
Since 2008 (**Restrict time series to 2012-present, when ATM methods were most similar?**), the biomass of the northern stock of Pacific Sardine has declined while the biomasses of the central stock of Northern Anchovy and Jack Mackerel have increased (**Fig. \@ref(fig:biomass-ts-line)**). Since approximately 2015, the biomass of the CPS assemblage has increased and been comprised primarily of the central stock of Norhtern Anchovy and Jack Mackerel (**Fig. \@ref(fig:biomass-ts-bar)**).  

(ref:biomass-ts-line) Estimated biomasses ($t$) of CPS in the CCE since **2008**. Error bars are 95% confidence intervals. **Confidence intervals are not yet available for all estimates (Juan will provide prior to publication).**
...
In 2014 and 2015, coincident with the overall decline in forage fish biomass (**Fig. \@ref(fig:biomass-ts-bar)**) were mass strandings, deaths, and reproductive failures in brown pelicans, common murres, Brandt’s cormorants, and California sea lions **[REFS]**. **[Juan, discuss how the split in the CCE S of Vancouver Island minimizes the impact of herring trends on mortality events, as you mentioned?] [Dave/Juan, other discusssion points about the biomass time series?]** 
