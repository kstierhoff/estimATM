...
On the three USVs (SD-1045, SD-1046, and SD-1047), a miniature wideband transceiver (EK80 WBT-Mini, Simrad) was configured with a gimbaled, keel-mounted, dual-frequency transducer (ES38-18|200-18, Simrad). Both the split-beam 38-kHz and single-beam 200-kHz had nominally 18$^\circ$ beamwidths.  
...
Calibration parameters were estimated from a tank calibration using a WC38.1. Beam model results (**Table \@ref(tab:cal-results-lbc)**) were entered into the GPT-control software (EK80, Simrad).
...
Calibration parameters were estimated from dockside calibrations with a WC38.1 conducted by Saildrone, Inc. Beam model results (**Table \@ref(tab:cal-results-sd-ns)**) were applied in Echoview during post-processing.

(ref:cal-results-sd-ns) Wideband transceiver (EK80 WBT-Mini, Simrad) beam model results estimated from dockside calibrations with a WC38.1. Calibrated on-axis gain ($G_0$), beam angles and angle offsets, and $S_a$ Correction ($S_\mathrm{a}\mathrm{corr}$) values were applied in Echoview during post-processing.
...
Since 2008 (**Restrict time series to 2012-present, when ATM methods were most similar?**), the biomass of the northern stock of Pacific Sardine has declined while the biomasses of the central stock of Northern Anchovy and Jack Mackerel have increased (**Fig. \@ref(fig:biomass-ts-line)**). In 2014 and 2015, coincident with the overall decline in forage fish biomass (**Fig. \@ref(fig:biomass-ts-bar)**) were mass strandings, deaths, and reproductive failures in brown pelicans, common murres, Brandt’s cormorants, and California sea lions **[REFS]**. Since then, the biomass of the CPS assemblage has increased and been comprised primarily of the central stock of Norhtern Anchovy and Jack Mackerel.  

**[Juan, discuss how the split in the CCE S of Vancouver Island minimizes the impact of herring trends on mortality events, etc.?]**

**[Dave/Juan, other discusssion points about the biomass time series?]**  

(ref:biomass-ts-line) Estimated biomasses ($t$) of CPS in the CCE since **2008**. Error bars are 95% confidence intervals. **Confidence intervals are not available for all estimates.**
...
(ref:biomass-ts-bar) Total biomass ($t$) of the CPS assemblage in the CCE since **2008**. Fill colors indicate the proportion of biomass attributed to each species.
...
## Biomass trends {#discussion-biomass-trends}  

**[Add discussion of biomass trends over time]**
...
* Two USVs that surveyed acoustic transects offshore, where wind was ample, provided sampling that was coincident with that from _`r survey.vessel`_, and increased the collection of acoustic backscatter data throughout approximately two-thirds of the survey area;
...
* A small amount of backscatter in the offshore area was expanded over a large offshore area, resulting in a relatively large (40%) addition of backscatter in that region; few offshore trawls were available to characterize species and size composition; therefore, **X%** of backscatter observed in the offshore region was not attributed to any of the five CPS species.
    + A distance filter was used to constrain the acoustic intervals that were <= 30 nmi to a positive trawl cluster, which was thought to be representative of CPS scatterers in the region?
+ With the exception of Jack Mackerel, little CPS biomass was observed in the offshore area.
+ Biomass in the offshore strata amounted to ~1-10% of the total biomass observed in the core an nearshore regions.
