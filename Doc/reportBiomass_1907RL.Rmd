...
```{r trawl-cluster-map,fig.cap='(ref:trawl-cluster-map)',out.width='4.5in',fig.pos='H'}
include_graphics(here("Figs/fig_nasc_cluster_trawl_proportion.png"))
```  
...
include_graphics(here("Figs/fig_acoustic_strata.png"))
```  
...
include_graphics(here("Figs/fig_nasc_cufes_trawl_proportion.png"))
```  
