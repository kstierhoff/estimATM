...
author: "Juan P. Zwolinski, Kevin L. Stierhoff, Josiah S. Renfree and David A. Demer"
...
Additional sampling was conducted nearshore along 5-nmi-long transects spaced 5 nmi apart between Pt. Conception and San Diego using _Long Beach Carnage_ equipped with multi-frequency echosounders (magenta lines, **Fig. \@ref(fig:survey-plan)**). The goal of the nearshore sampling was to estimate the abundance and biomass of CPS close to shore, in shallow water, or both, where _`r survey.vessel`_ could not safely navigate or trawl.  
...
(ref:survey-plan) Planned compulsory (solid black lines) transect lines sampled by _`r survey.vessel`_; nearshore transect lines sampled by _Long Beach Carnage_ (solid magenta lines); 50-, 200-, 500-, and 2,000-m isobaths (light gray lines).
