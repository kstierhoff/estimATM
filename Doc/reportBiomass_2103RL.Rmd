...
The potential habitat of the northern stock of Pacific Sardine was widespread in the core survey area (**Fig. \@ref(fig:sardine-potential-habitat)a**). However, the majority of Pacific Sardine were encountered nearshore, in waters where the model indicated unsuitable habitat due to excessive chlorophyll a concentration (**Fig. \@ref(fig:sardine-potential-habitat)b**). Nonetheless, the temperatures associated with all the Pacific Sardine sampled were in the range of those associated to the northern stock (**Fig. \@ref(fig:sardine-potential-habitat)c**). Therefore, the the `r prettyNum(be.all.summ$Biomass[be.all.summ$Species == "Sardinops sagax" & be.all.summ$Stock == "Northern"], big.mark=",",digits=5)` t (CI~95%~ = `r prettyNum(be.all.summ$lower.ci.B[be.all.summ$Species == "Sardinops sagax" & be.all.summ$Stock == "Northern"], big.mark=",",digits=4)` - `r prettyNum(be.all.summ$upper.ci.B[be.all.summ$Species == "Sardinops sagax" & be.all.summ$Stock == "Northern"],big.mark=",",digits=5)` t) of biomass estimated there were attributed to the northern stock of Pacific Sardine.
