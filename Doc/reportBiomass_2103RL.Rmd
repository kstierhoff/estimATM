...
This document describes, in detail, the ATM as presently used by NOAA's Southwest Fisheries Science Center (SWFSC) to survey the distributions and abundances of CPS and their oceanographic environments [e.g., @Cutter2008;@Demer2012;@Zwolinski2014]. In general terms, the contemporary ATM combines information from satellite-sensed oceanographic conditions, calibrated multifrequency echosounders, probe-sampled oceanographic conditions, pumped samples of fish eggs, and trawl-net catches of juvenile and adult CPS. The survey area is initially defined with consideration to the expected distribution of a priority stock or stock assemblage, in this case, the central stock of Northern Anchovy (**Fig. \@ref(fig:anchovy-distribution)**). The survey area is further expanded to encompass as much of the potential habitat as possible for other CPS present off the West Coast of the U.S., as time permits.  
...
(ref:anchovy-distribution) Distribution of eggs of Northern Anchovy sampled by the CUFES during spring surveys from 2017 through 2019. Eggs indicate the presence of spawning Northern Anchovy and were used to delineate the spring 2021 survey area.
...
In `r tolower(survey.season)` `r survey.year`, the ATM survey performed aboard NOAA Ship _`r survey.vessel.long`_ (hereafter, _`r survey.vessel`_) was augmented with coordinated sampling by a fishing vessel (F/V _Long Beach Carnage_, hereafter _LBC_) to estimate the biomasses of CPS in nearshore regions where sampling by _`r survey.vessel`_ was not possible or safe.  

Presented here are: 1) a detailed description of the ATM used to survey CPS in the CCE off the west coast of North America; and 2) estimates of the abundance, biomass, size structure, and distribution of CPS, specifically the central stock of Northern Anchovy, Pacific Sardine, Pacific Mackerel, and Jack Mackerel for the core and nearshore survey regions. Additional details about the survey may be found in the survey report [@Stierhoff2022b].  

# Methods {#methods}
## Data collection {#methods-data-collection}
### Survey design {#methods-survey-design}  

The `r tolower(survey.season)` `r survey.year` survey was conducted principally using _`r survey.vessel`_. The sampling domain, between San Francisco and San Diego, was defined by the expected distribution of the central stock of Northern Anchovy (**Fig. \@ref(fig:anchovy-distribution)**), which also includes part of the predicted distribution of the northern stock of Pacific Sardine (**Fig. \@ref(fig:sardine-potential-habitat)a**). East to west, the sampling domain extends from the coast to at least the 1,000 fathom (~1830 m) isobath (**Fig. \@ref(fig:survey-plan)**). Considering the expected distribution of the target species, the acceptable uncertainty in biomass estimates, and the available ship time (`r survey.das` days at sea, DAS), the principal survey objectives were the estimations of biomass for the central stock of Northern Anchovy in the survey region. Additionally, biomass estimates were sought for Pacific Sardine, Pacific Mackerel, and Jack Mackerel in the survey region.  

\newpage
\blandscape

(ref:sardine-potential-habitat) Distribution of a) potential habitat for the northern stock of Pacific Sardine; b) sea surface temperature (SST); and c) chlorophyll-a concentration. The images are 8-day composites including data from 23 March to 1 April, 2021.
...
North of Point Conception, the transects were spaced 20 nmi apart, and extend from the shallowest navigable depth (~30 m) to either a distance of 35 nmi or to the 1,000-fathom isobath, whichever is farthest (**Fig. \@ref(fig:survey-plan)**). South of Point Conception, the transects were spaced 15 nmi apart, and were as long as 70 nmi. Throughout the survey, where CPS were observed within the westernmost end of the transect, that transect and the next one to the north were extended as long as CPS echoes were visible in the echosounders. The aim was to reach the end of the transects with a practically “zero” biomass density.  

Additional sampling was conducted nearshore along 5-nmi-long transects spaced 5 nmi apart between Pt. Conception and San Diego using _LBC_ equipped with multi-frequency echosounders (magenta lines, **Fig. \@ref(fig:survey-plan)**). The goal of the nearshore sampling was to estimate the abundance and biomass of CPS close to shore, in shallow water, or both, where _`r survey.vessel`_ could not safely navigate or trawl.  

The transects were perpendicular to the coast, extending from the shallowest navigable depth (~30 m) to either a distance of 35 nmi or to the 1,000 fathom isobath, whichever is farthest (**Fig. \@ref(fig:survey-plan)**). When CPS were observed within the westernmost 3 nmi of a transect, that transect and the next one to the south were extended in 5-nmi increments until no CPS were observed in the last 3 nmi of the extension.  

(ref:survey-plan) Planned compulsory (solid black lines) transect lines sampled by _`r survey.vessel`_; nearshore transect lines sampled by _LBC_ (solid magenta lines); 50-, 200-, 500-, and 2,000-m isobaths (light gray lines).
...
A purse seine net, ~290-m-long and ~22-m-deep net with ~17.5 mm mesh size, was set from _LBC_ to provide information about size, age, and species composition of fishes observed in the echosounders in the nearshore region. All specimens collected were frozen and later processed by the CA Department of Fish and Wildlife (CDFW).  
...
(ref:l-freq-summ-sar-s) Abundance versus standard length ($L_S$, cm) for Pacific Sardine (_Sardinops sagax_) in the core and nearshore survey regions.
...
(ref:biom-dens-sar-s) Biomass densities of Pacific Sardine (_Sardinops sagax_), per strata, in the a) core and b) nearshore survey regions. The blue numbers represent the locations of trawl clusters with at least one Pacific Sardine. The gray line represents the vessel track.
...
(ref:l-disagg-sar-s) Estimated abundance (upper panel) and biomass (lower panel) versus standard length ($L_S$, cm) for Pacific Sardine (_Sardinops sagax_) in the core and nearshore survey regions.
...
Despite most _`r survey.vessel`_ transects having ended with practically zero biomass densities at their western ends, the declines are sharp, raising the question of whether or not _`r survey.vessel`_ reached the absolute western edge of the anchovy distribution in the SCB. Analysis of egg distribution data from the spring CalCOFI survey indicates that the abundance of anchovy offshore of the survey area is likely small (**Appendix \@ref(appendix-anchovy-distribution)**).  Data collected during the subsequent ATM survey in Summer 2021 provides more information on this possible bias.  

### Pacific Sardine {#discussion-sardine}     

While the core survey area included good and optimal habitat for the northern stock of Pacific Sardine (**Fig. \@ref(fig:sardine-potential-habitat)a**), the nearshore areas where all of the Pacific Sardine were sampled (**Fig. \@ref(fig:sardine-habitat-spring2021)**), had unsuitable habitat due to excessive chlorophyll-a concentration (**Fig. \@ref(fig:sardine-potential-habitat)b**). Also, Pacific Sardine eggs were absent from the nearshore, indicating that the Pacific Sardine, with a modal length between 12 and 13 cm, were immature, age-0 fish. The forecasted growth for those Pacific Sardine in a period of four to five months matches the 16 to 18 cm lengths of Pacific Sardine attributed to the southern stock in the subsequent summer survey (Stierhoff et al., _in prep_), indicating that these sardine recruited locally to the southern stock. Additionally, there were no Pacific Sardine with comparable sizes in the areas sampled off Oregon and Washing during the summer (**Fig. \@ref(fig:sardine-stock-allocation)**), indicating that few or none of the Pacific Sardine observed in the spring in the SCB migrated and recruited to the northern stock. Therefore, the Pacific Sardine observed in the spring 2021 survey, with a biomass of `r prettyNum(be.all.summ$Biomass[be.all.summ$Species == "Sardinops sagax" & be.all.summ$Stock == "Southern"], big.mark=",",digits=5)` t (CI~95%~ = `r prettyNum(be.all.summ$lower.ci.B[be.all.summ$Species == "Sardinops sagax" & be.all.summ$Stock == "Southern"], big.mark=",",digits=4)` - `r prettyNum(be.all.summ$upper.ci.B[be.all.summ$Species == "Sardinops sagax" & be.all.summ$Stock == "Southern"],big.mark=",",digits=5)` t), were attributed to the southern stock.  

\newpage
\blandscape

(ref:sardine-habitat-spring2021) The spatial distribution of Pacific Sardine during the spring survey overlaid on the potential habitat for the northern stock. The nearshore waters of the Southern California Bight during late March 2021 were unsuitable or bad for the northern stock of Pacific Sardine based on the model [@Zwolinski2011].
...
(ref:sardine-stock-allocation) Relative abundance versus standard length for Pacific Sardine (_Sardinops sagax_) estimated during this survey (top panel) and the summer 2021 survey (Stierhoff et al., _in prep_), separated by putative southern (middle panel) and northern stocks (lower panel). The relative abundance of the summer survey is preliminary.
...
There was a negligible amount of Pacific mackerel observed by _`r survey.vessel`_ and _LBC_. The subsequent ATM survey in summer 2021 will provide a better indication of the status of this stock.  
