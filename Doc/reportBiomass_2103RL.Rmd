...
While the good and optimal habitats for the northern stock of Pacific Sardine were widespread in the core survey area (**Fig. \@ref(fig:sardine-potential-habitat)a**), they were absent in the nearshore where all the sardine were sampled, and where the habitat model indicated unsuitable conditions due to excessive chlorophyll a concentration (**Fig. \@ref(fig:sardine-potential-habitat)b**). Also, Pacific Sardine eggs were absent from the nearshore, suggesting that the Pacific Sardine, with a modal length between 12 and 13 cm, were mostly comprised of immature, age-0 fish. The expected growth for those Pacific Sardine in a period of four to five months matches with the 16 to 18 cm sardine attributed to the southern stock in the subsequent summer survey (Stierhoff et al., _in prep_), and no the much larger size range of animals (20 to 29 cm) attributed to the northern stock (**Fig. \@ref(fig:sardine-stock-allocation)**). Therefore, the Pacific Sardine observed in the spring 2021 survey apparently recruited to the southern stock, and the entire `r prettyNum(be.all.summ$Biomass[be.all.summ$Species == "Sardinops sagax" & be.all.summ$Stock == "Northern"], big.mark=",",digits=5)` t (CI~95%~ = `r prettyNum(be.all.summ$lower.ci.B[be.all.summ$Species == "Sardinops sagax" & be.all.summ$Stock == "Northern"], big.mark=",",digits=4)` - `r prettyNum(be.all.summ$upper.ci.B[be.all.summ$Species == "Sardinops sagax" & be.all.summ$Stock == "Northern"],big.mark=",",digits=5)` t) of biomass is attributed to the southern stock.  

(ref:sardine-stock-allocation) Relative abundance versus standard length for Pacific Sardine (_Sardinops sagax_) estimated during this survey (top panel) and the summer 2021 survey (Stierhoff et al., _in prep_), separated by southern (middle panel) and northern stocks (lower panel). The relative abundance of the summer survey is preliminary, and it is subject to change.

```{r sardine-stock-allocation,fig.cap='(ref:sardine-stock-allocation)',out.width='6in',fig.pos='H'}
# Add figure provided by Juan
include_graphics(here("Figs/fig_sardine_stock_allocation.jpg"))  
``` 
