...
The biomass of the central stock of Northern Anchovy occupied mostly the central to western sections of the survey area (**Fig. \@ref(fig:biom-dens-anch-c)a**). Two lines or reason indicate that the estimated stock biomass was not substantially biased due to unsampled Northern Anchovy farther offshore. First, and most significantly, there was practically zero biomass on the western ends of all the survey transects (**Fig. \@ref(fig:offshore-anchovy)**). Second, there were few Northern Anchovy eggs west of the Spring 2021 CPS Survey area during the Spring 2021 CalCOFI Survey (unpublished data), less than a month later.  
