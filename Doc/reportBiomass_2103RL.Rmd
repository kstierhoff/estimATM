...
(ref:sardine-potential-habitat) Distribution of a) potential habitat for the northern stock of Pacific Sardine; b) SST; c) natural logarithm of Chlorophyll-a concentration. The images are 8-day composite images ending on 1 April, 2021.   **[Kevin to revise figure based on comments from Dave and Juan]**
...
(ref:ctd-app) Compressed echogram of echoes from fishes with swimbladders retained with the Echoview processing (top); and integrated echo energy versus depth, reconstructed echogram in R, where blue lines delineate the vertical extent of the area retained for vertical integration of CPS (bottom). **[Update with new figure.]**
