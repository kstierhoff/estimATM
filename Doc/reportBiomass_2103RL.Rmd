...
The estimated biomass of Pacific Sardine, from approximately Pt. Conception to San Diego,  was `r prettyNum(be.all.summ$Biomass[be.all.summ$Species == 'Sardinops sagax' & be.all.summ$Stock == "Northern"],big.mark=",",digits=3)` t (CI~95%~ = `r prettyNum(be.all.summ$lower.ci.B[be.all.summ$Species == 'Sardinops sagax' & be.all.summ$Stock == "Northern"],big.mark=",",digits=3)` - `r prettyNum(be.all.summ$upper.ci.B[be.all.summ$Species == 'Sardinops sagax' & be.all.summ$Stock == "Northern"],big.mark=",",digits=3)` t, CV = `r prettyNum(be.all.summ$biomass.cv[be.all.summ$Species == 'Sardinops sagax' & be.all.summ$Stock == "Northern"],big.mark=",",digits=1)`%). Only 5% of the total biomass, `r prettyNum(be.all$Biomass[be.all$Species == 'Sardinops sagax' & be.all$Stock == "Northern"],big.mark=",",digits=3)` t (CI~95%~ = `r prettyNum(be.all$lower.ci.B[be.all$Species == 'Sardinops sagax' & be.all$Stock == "Northern"],big.mark=",",digits=3)` - `r prettyNum(be.all$upper.ci.B[be.all$Species == 'Sardinops sagax' & be.all$Stock == "Northern"],big.mark=",",digits=3)` t, CV = `r prettyNum(be.all$biomass.cv[be.all$Species == 'Sardinops sagax' & be.all$Stock == "Northern"],big.mark=",",digits=1)`%), was in the core region. The remaining `r prettyNum((be.all.ns$Biomass[be.all.ns$Species == 'Sardinops sagax' & be.all.ns$Stock == "Northern"] / (be.all.ns$Biomass[be.all.ns$Species == 'Sardinops sagax' & be.all.ns$Stock == "Northern"] + be.all$Biomass[be.all$Species == 'Sardinops sagax' & be.all$Stock == "Northern"]))*100,big.mark=",",digits=2)`%, `r prettyNum(be.all.ns$Biomass[be.all.ns$Species == 'Sardinops sagax' & be.all.ns$Stock == "Northern"],big.mark=",",digits=3)` t (CI~95%~ = `r prettyNum(be.all.ns$lower.ci.B[be.all.ns$Species == 'Sardinops sagax' & be.all.ns$Stock == "Northern"],big.mark=",",digits=3)` - `r prettyNum(be.all.ns$upper.ci.B[be.all.ns$Species == 'Sardinops sagax' & be.all.ns$Stock == "Northern"],big.mark=",",digits=3)` t, CV = `r prettyNum(be.all.ns$biomass.cv[be.all.ns$Species == 'Sardinops sagax' & be.all.ns$Stock == "Northern"],big.mark=",",digits=1)`%), was in the nearshore region, exclusively in waters labeled unsuitable for the northern stock of Pacific Sardine due to excessive chlorophyll-a concentration. Also, Pacific Sardine eggs were absent from the nearshore, suggesting that the Pacific Sardine, with a modal length between 12 and 13 cm, were mostly comprised of immature, age-0 fish. The forecasted growth for those Pacific Sardine in a period of four to five months results in a match with the 16 to 18 cm Pacific Sardine attributed to the southern stock in the SCB in the subsequent 2021 summer survey, suggesting they recruited locally the southern stock. This view is further supported by the absence of these smaller Pacific Sardine off Oregon and Washington during the subsequent summer survey, which indicates that virtually none of the fish observed in the spring in the SCB undertook the seasonal migration and recruited to the northern stock. Therefore, the Pacific Sardine observed in the spring 2021 survey were attributed to the southern stock.  
...
While the good and optimal habitats for the northern stock of Pacific Sardine were widespread in the core survey area (**Fig. \@ref(fig:sardine-potential-habitat)a**), they were absent in the nearshore where all the sardine were sampled (**Fig. \@ref(fig:sardine-habitat-spring2021)**), and where the habitat model indicated unsuitable conditions due to excessive chlorophyll a concentration (**Fig. \@ref(fig:sardine-potential-habitat)b**). Also, Pacific Sardine eggs were absent from the nearshore, suggesting that the Pacific Sardine, with a modal length between 12 and 13 cm, were mostly comprised of immature, age-0 fish. The forecasted growth for those Pacific Sardine in a period of four to five months results in a match with the 16 to 18 cm sardine attributed to the southern stock in the subsequent summer survey (Stierhoff et al., _in prep_), suggesting these sardine recruited locally to the southern stock. In addition, there were no Pacific Sardine with comparable sizes within those sampled during the summer off Oregon and Washing during the summer (**Fig. \@ref(fig:sardine-stock-allocation)**), suggesting that few or none of the Pacific Sardine observed in the spring in the SCB undertook the seasonal migration and recruited to the northern stock. Therefore, the Pacific Sardine observed in the spring 2021 survey, with a biomass of `r prettyNum(be.all.summ$Biomass[be.all.summ$Species == "Sardinops sagax" & be.all.summ$Stock == "Northern"], big.mark=",",digits=5)` t (CI~95%~ = `r prettyNum(be.all.summ$lower.ci.B[be.all.summ$Species == "Sardinops sagax" & be.all.summ$Stock == "Northern"], big.mark=",",digits=4)` - `r prettyNum(be.all.summ$upper.ci.B[be.all.summ$Species == "Sardinops sagax" & be.all.summ$Stock == "Northern"],big.mark=",",digits=5)` t), were attributed to the southern stock.  

\newpage
\blandscape

(ref:sardine-habitat-spring2021) Spatial distribution of Pacific Sardine during the spring survey overlaid on the potential habitat for the northern stock. The inshore waters of the Southern California Bight during late March 2021 were labeled as unsuitable or bad for the northern stock of Pacific Sardine based on the metric proposed by Zwolinski et al. [-@Zwolinski2011].
...
(ref:sardine-stock-allocation) Relative abundance versus standard length for Pacific Sardine (_Sardinops sagax_) estimated during this survey (top panel) and the summer 2021 survey (Stierhoff et al., _in prep_), separated by putative southern (middle panel) and northern stocks (lower panel). The relative abundance of the summer survey is preliminary, and it is subject to change.
