...
author: 
  ...
  - J.P. Zwolinski, U.C. Santa Cruz, The Cooperative Institute for Marine, Earth, and Atmospheric Systems (CIMEAS)
...
To increase the spatial sampling resolution, acoustic sampling was conducted by USVs on transects interstitial to _`r survey.vessel`_ transects from Cape Flattery, WA to Crescent City, CA and from Point Arena, CA to Point Conception, CA (SD-1036, SD-1055, and SD-1059; yellow lines, **Fig. \@ref(fig:survey-plan)**). USVs (SD-1036 and SD-1059) were additionally used to sample offshore extensions of _`r survey.vessel`_'s transects in the SCB. 

To estimate the abundances and biomasses of CPS close to shore, in shallow water, or both, where _`r survey.vessel`_ could not efficiently or safely navigate or trawl, acoustic and purse seine sampling was conducted nearshore between Cape Flattery and San Diego using two fishing vessels equipped with multi-frequency echosounders (magenta lines, **Fig. \@ref(fig:survey-plan)**). F/V _Lisa Marie_ sampled 5-nmi-long transects spaced 5 nmi apart between Cape Flattery and Bodega Bay. F/V _Long Beach Carnage_ sampled 5-nmi-long transects spaced 5 nmi apart between Bodega Bay and San Diego, and 2.5-nmi-long transects spaced 2.5 nmi apart around Santa Cruz and Santa Catalina Islands in the SCB.  

(ref:sardine-potential-habitat) Distribution of potential habitat for the northern stock of Pacific Sardine, temporally aggregated using an average of the habitat centered ±2° around the positions of _`r survey.vessel`_, _Carranza_, and USVs throughout the survey. Areas in white correspond to no available data, e.g., cloud coverage preventing satellite-sensed observations.
...
Multi-frequency Wide-Bandwidth Transceivers (18-, 38-, 70-, 120-, 200-, and 333-kHz Simrad EK80 WBTs; Kongsberg) were configured with split-beam transducers (`r echo.models`, respectively; Kongsberg). The transducers were mounted on the bottom of a retractable keel or "centerboard" (**Fig. \@ref(fig:cb-config)**). The keel was retracted (transducers at ~`r cb.retracted`-m depth) during calibration, and extended to the intermediate position (transducers at ~`r cb.intermediate`-m depth) during the survey. Exceptions were made during shallow water operations, when the keel was retracted; or during times of heavy weather, when the keel was extended (transducers at ~`r cb.extended`-m depth) to provide extra stability and reduce the effect of weather-generated noise. In addition, acoustic data were also collected using a multibeam echosounder (Simrad ME70; Kongsberg), multibeam sonar (Simrad MS70; Kongsberg), scanning sonar (Simrad SX90; Kongsberg), acoustic Doppler current profiler and echosounder (Simrad EC150-3C, Kongsberg), and a separate ADCP (Ocean Surveyor Model OS75; Teledyne RD Instruments). Transducer position and motion were measured at 5 Hz using an inertial motion unit (Applanix POS-MV; Trimble).  

##### _Carranza_  

Multi-frequency General Purpose Transceivers (18-, 38-, 70-, 120-, and 200-kHz EK60 GPTs; Kongsberg) were configured with split-beam transducers (ES18, ES38B, ES70-7C, ES120-7C, and ES200-7C; Kongsberg) mounted on the bottom of a retractable keel, placing them approximately 4 m beneath the water surface.  

##### _Lisa Marie_  

The SWFSC's General Purpose Transceiver (38-kHz Simrad EK60 GPT; Kongsberg) was connected to the vessel's hull-mounted split-beam transducer (ES38B; Kongsberg; not shown).  

##### _Long Beach Carnage_

The SWFSC's multi-frequency General Purpose Transceivers (38-, 70-, 120-, and 200-kHz EK60 GPTs; Kongsberg) were configured with the SWFSC's split-beam transducers (ES38-12, ES70-7C, ES120-7C and ES200-7C; Kongsberg) mounted in a multi-frequency transducer array (MTA4) on the bottom of a pole (**Fig. \@ref(fig:cb-config-lbc)**).  
...
Up to three trawls were conducted each night using an approach similar to _`r survey.vessel`_.  
...
(ref:extract-nasc) Echoes from fishes with swimbladders (blue points, scaled by backscatter intensity) along an example acoustic transect (top) and the corresponding echogram image (bottom). In this example, the blue and green lines indicate the upper and lower boundaries within which echoes were retained. When the lower boundary is deeper than the seabed (bold, black line), echoes above the seabed are retained.  Echoes from deep, bottom-dwelling schools of non-CPS fishes with swimbladders, and from diffuse scatterers near the surface were excluded. The proximity of the echoes to the seabed was also used to define the lower limit for vertical integration.
...
Acoustic backscatter ascribed to CPS was observed throughout the latitudinal range of the core survey area (**Fig. \@ref(fig:nasc-cufes-trawl)a**). Between approximately Fort Bragg and Pt. Conception, backscatter from CPS was present from near the coast to the shelf break, but was compressed along the coast to the north and south and around the Channel Islands in the SCB. Zero-biomass intervals were observed at the offshore end of each transect in the core region. The majority (greater than `r cum.biomass.limit*100`%) of biomass for each species was apportioned using catch data from trawl clusters conducted within a distance of $\leq$ 30 nmi (**Fig. \@ref(fig:biomass-cluster-distance)**).  
...
Northern Anchovy were predominant, by weight, in purse seine samples collected nearshore by _Long Beach Carnage_ off central CA between Cape Mendocino and Monterey Bay, and in the SCB between Los Angeles and Long Beach (**Fig. \@ref(fig:nasc-seine-lbc)b**). Pacific Sardine were predominant between Big Sur and Pt. Conception; between Long Beach and San Diego; and around Santa Cruz and Santa Catalina Islands  (**Fig. \@ref(fig:nasc-seine-lbc)b**). Some Pacific Mackerel were collected between Oceanside, CA and San Diego and around Santa Cruz and Santa Catalina Islands, and Jack Mackerel were collected between Big Sur and Morro Bay, and off San Diego (**Fig. \@ref(fig:nasc-seine-lbc)b**). Overall, scoops sampled from `r num2words(nrow(lbc.sets))` seines totaled `r prettyNum(sum(seine.summ.lbc$total.wt),big.mark=",",digits=3)` kg of CPS (`r prettyNum(seine.summ.lbc$total.wt[seine.summ.lbc$scientificName == "Sardinops sagax"],big.mark=",",digits=3)` kg of Pacific Sardine, `r prettyNum(seine.summ.lbc$total.wt[seine.summ.lbc$scientificName == "Scomber japonicus"],big.mark=",",digits=3)` kg of Pacific Mackerel, `r prettyNum(seine.summ.lbc$total.wt[seine.summ.lbc$scientificName == "Trachurus symmetricus"],big.mark=",",digits=2)` kg of Jack Mackerel, and `r prettyNum(seine.summ.lbc$total.wt[seine.summ.lbc$scientificName == "Engraulis mordax"],big.mark=",",digits=2)` kg of Northern Anchovy; no Pacific Herring were collected). 
...
(ref:biom-dens-anch-n) Biomass densities of the northern stock of Northern Anchovy (_Engraulis mordax_), per strata, in the a) core and b) nearshore survey regions. The blue numbers represent the locations of trawl clusters with at least one Northern Anchovy. The gray line represents the vessel track.
...
(ref:l-freq-summ-jack) Abundance versus fork length ($L_F$, cm) for Jack Mackerel (_Trachurus symmetricus_) in the core and nearshore survey regions. **[Remove columns for Species and Stock, here and for other species with only one of each]**
...
The principal objectives of the `r survey.das`-day, summer 2021 CCE Survey were to estimate the biomasses and distributions of the northern and southern stocks of Pacific Sardine and the northern and central stocks of Northern Anchovy. Then, as possible, produce estimates for Pacific Mackerel, Jack Mackerel, Pacific Herring, and Round Herring. 

Despite inclement weather conditions, mechanical limitations, and logistical challenges related to the COVID-19 pandemic, _`r survey.vessel`_ surveyed from Cape Flattery to El Rosario off Baja CA, and _Carranza_ extended the survey area from El Rosario to just south of Punta Abreojos.

This is the first time that the ATM sampling has been coordinated with colleagues from INAPESCA sampling from _Carranza_, which allowed for relatively unbiased estimates of the central stock of Northern Anchovy and the southern stock of Pacific Sardine, whose distributions extend south of the U.S.-Mexico border.  
...
The estimated biomass of the northern stock of Northern Anchovy in the survey region north of Cape Mendocino was `r prettyNum(be.all.summ$Biomass[be.all.summ$Species == "Engraulis mordax" & be.all$Stock == "Northern"], big.mark=",", digits = 4)` t (CI~95%~ = `r prettyNum(be.all.summ$lower.ci.B[be.all.summ$Species == "Engraulis mordax" & be.all.summ$Stock == "Northern"],big.mark=",",digits=4)` - `r prettyNum(be.all.summ$upper.ci.B[be.all.summ$Species == "Engraulis mordax" & be.all.summ$Stock == "Northern"],big.mark=",",digits=5)` t) in summer 2021. The northern stock biomass has comprised a relatively small fraction of the total biomass in the ATM surveys conducted in the CCE since at least 2015 [@Stierhoff2021a].  

#### Central stock {#discussion-anchovy-biomass-central}  

The estimated biomass of the central stock of Northern Anchovy in the survey region was `r prettyNum(be.all.summ$Biomass[be.all.summ$Species == "Engraulis mordax" & be.all$Stock == "Central"], big.mark=",", digits = 5)` t (CI~95%~ = `r prettyNum(be.all.summ$lower.ci.B[be.all.summ$Species == "Engraulis mordax" & be.all.summ$Stock == "Central"],big.mark=",",digits=5)` - `r prettyNum(be.all.summ$upper.ci.B[be.all.summ$Species == "Engraulis mordax" & be.all.summ$Stock == "Central"],big.mark=",",digits=5)` t) in summer 2021, which represents a ~`r round(be.all.summ$Biomass[be.all.summ$Species == "Engraulis mordax" & be.all$Stock == "Central"]/810634, digits=1)`-fold increase over the 810,634 t (CI~95%~ = 587,317 - 1,066,265) estimated in summer 2019 [@Stierhoff2020b] and a ~`r round(be.all.summ$Biomass[be.all.summ$Species == "Engraulis mordax" & be.all$Stock == "Central"]/1371634,1)`-fold increase over the 1,371,634 t estimated in spring 2021 [@Zwolinski2022b]. Only `r prettyNum(sum(be.anch.c$Biomass[be.anch.c$Stratum %in% c(1,2)])/sum(be.anch.c$Biomass)*100, big.mark=",", digits = 1)`% of the central stock Northern Anchovy biomass was observed in Mexican waters. Since 2018, the central stock of Northern Anchovy has been the dominant forage fish species in the survey area (**Figs. \@ref(fig:biomass-ts-line)** and **\@ref(fig:biomass-ts-bar)**), and comprised `r round(be.all.summ$Biomass[be.all$Species == "Engraulis mordax" & be.all$Stock == "Central"]/sum(be.all.summ$Biomass)*100)`% of the total CPS biomass in summer 2021.  

### Pacific Sardine {#discussion-sardine}     
#### Northern stock {#discussion-sardine-biomass-northern}  

Similar to spring 2021 [@Zwolinski2022b], the boundary between the northern and southern stocks of Pacific Sardine was San Francisco, based on differences in the size distributions and the patterns of biomass density north and south of San Francisco Bay ((**Figs. \@ref(fig:biomass-ts-line)** and **\@ref(fig:biomass-ts-bar), but confirm with Juan**). The estimated biomass of `r prettyNum(be.all.summ$Biomass[be.all.summ$Species == "Sardinops sagax" & be.all$Stock == "Northern"], big.mark=",", digits = 5)` t (CI~95%~ = `r prettyNum(be.all.summ$lower.ci.B[be.all.summ$Species == "Sardinops sagax" & be.all.summ$Stock == "Northern"], big.mark=",",digits=5)` - `r prettyNum(be.all.summ$upper.ci.B[be.all.summ$Species == "Sardinops sagax" & be.all.summ$Stock == "Northern"], big.mark=",",digits=5)` t) in the survey region was a `r round((be.all.summ$Biomass[be.all.summ$Species == "Sardinops sagax" & be.all.summ$Stock == "Northern"]/33623)-1, digits=1)*100`% increase in biomass compared to the 33,623 t estimated in summer 2019 [@Stierhoff2020b]. The biomass of the northern stock of Pacific Sardine has remained relatively low but constant since 2014 (**Figs. \@ref(fig:biomass-ts-line)** and **\@ref(fig:biomass-ts-bar)**). 

\newpage

(ref:sardine-stock-allocation) **UPDATE** Relative abundance versus standard length for Pacific Sardine (_Sardinops sagax_) estimated during this survey (top panel) and the summer 2021 survey [@Stierhoff2022a], separated by putative southern (middle panel) and northern stocks (lower panel). The relative abundance of the summer survey is preliminary. **[Need to update caption to reflect new plot; get higher resolution plot, too]**

```{r sardine-stock-allocation,fig.cap='(ref:sardine-stock-allocation)',out.height='8in',fig.pos='H'}
# Add figure provided by Juan
include_graphics(here("Figs/fig_sardine_stock_structure_lengths_summer2021.png"))  
```
...
The estimated biomass of the southern stock of Pacific Sardine in the survey region was `r prettyNum(be.all.summ$Biomass[be.all.summ$Species == "Sardinops sagax" & be.all$Stock == "Southern"], big.mark=",", digits = 5)` t (CI~95%~ = `r prettyNum(be.all.summ$lower.ci.B[be.all.summ$Species == "Sardinops sagax" & be.all.summ$Stock == "Southern"], big.mark=",",digits=5)` - `r prettyNum(be.all.summ$upper.ci.B[be.all.summ$Species == "Sardinops sagax" & be.all.summ$Stock == "Southern"],big.mark=",",digits=5)` t). In summer 2021, `r prettyNum(sum(be.sar.s$Biomass[be.sar.s$Stratum %in% c(2:4)]), big.mark=",", digits = 5)` t (strata 2-4) of southern stock biomass was observed in U.S. waters, and the remaining `r prettyNum(sum(be.sar.s$Biomass[be.sar.s$Stratum ==1]), big.mark=",", digits = 5)` t (stratum 1; `r prettyNum(sum(be.sar.s$Biomass[be.sar.s$Stratum ==1])/sum(be.sar.s$Biomass)*100, big.mark=",", digits = 1)`% of the total biomass) was estimated in Mexican waters off Baja CA. In summer 2019, the estimated biomass was 8,322 t [@Stierhoff2020b], but the survey area did not extend past the U.S.-Mexico border in that year.  

### Pacific Mackerel {#discussion-mack}  

In summer 2021, the estimated biomass of Pacific Mackerel in the survey region was `r prettyNum(be.all.summ$Biomass[be.all.summ$Species == 'Scomber japonicus'],big.mark=",",digits=3)` t (CI~95%~ = `r prettyNum(be.all.summ$lower.ci.B[be.all.summ$Species == 'Scomber japonicus'],big.mark=",",digits=3)` - `r prettyNum(be.all.summ$upper.ci.B[be.all.summ$Species == 'Scomber japonicus'],big.mark=",",digits=3)` t), which was similar to the 24,643 t estimated in summer 2019, and remained withing the range of 8,000 t to 41,139 t estimated in the summers of 2013 [@Zwolinski2014] and 2018 [@Zwolinski2019a], respectively (**Figs. \@ref(fig:biomass-ts-line)** and **\@ref(fig:biomass-ts-bar)**).  

### Jack Mackerel {#discussion-jack}  

In summer 2021, the estimated biomass of Jack Mackerel in the survey region was `r prettyNum(be.all.summ$Biomass[be.all.summ$Species == 'Trachurus symmetricus'],big.mark=",",digits=3)` t (CI~95%~ = `r prettyNum(be.all.summ$lower.ci.B[be.all.summ$Species == 'Trachurus symmetricus'],big.mark=",",digits=3)` - `r prettyNum(be.all.summ$upper.ci.B[be.all.summ$Species == 'Trachurus symmetricus'],big.mark=",",digits=3)` t), which was `r round(be.all.summ$Biomass[be.all.summ$Species == 'Trachurus symmetricus']/385801,1)`-fold higher that the estimate of 385,801 t estimated in summer 2019 [@Stierhoff2020b]. Jack Mackerel was the second most abundant species overall, and comprised `r round(be.all.summ$Biomass[be.all.summ$Species == "Trachurus symmetricus"]/sum(be.all.summ$Biomass)*100)`% of the total CPS biomass in summer 2021 (**Figs. \@ref(fig:biomass-ts-line)** and **\@ref(fig:biomass-ts-bar)**).  

### Pacific Herring {#discussion-herring} 

In summer 2021, the estimated biomass of Pacific Herring in the survey region was `r prettyNum(be.all.summ$Biomass[be.all.summ$Species == 'Clupea pallasii'],big.mark=",",digits=3)` t (CI~95%~ = `r prettyNum(be.all.summ$lower.ci.B[be.all.summ$Species == 'Clupea pallasii'],big.mark=",",digits=3)` - `r prettyNum(be.all.summ$upper.ci.B[be.all.summ$Species == 'Clupea pallasii'],big.mark=",",digits=3)` t), which was `r round(be.all.summ$Biomass[be.all.summ$Species == 'Clupea pallasii']/267792*100,1)`% of the 267,792 t estimated in summer 2019 [@Stierhoff2020b]. However, the distribution of Pacific Herring in summer 2021 was more patchy and closer to shore, similar to 2017 [@Zwolinski2019a] and 2018 [@Stierhoff2019b] compared to its distribution in 2019 that spanned a greater portion of the continental shelf. Furthermore, the summer 2021 survey did not survey the coast of Vancouver Island, where much of the Pacific Herring biomass was observed in 2019. 

### Round Herring {#discussion-rherring} 

In summer 2021, the estimated biomass of Round Herring in the core survey region was `r prettyNum(be.all.summ$Biomass[be.all.summ$Species == 'Etrumeus acuminatus'],big.mark=",",digits=3)` t (CI~95%~ = `r prettyNum(be.all.summ$lower.ci.B[be.all.summ$Species == 'Etrumeus acuminatus'],big.mark=",",digits=3)` - `r prettyNum(be.all.summ$upper.ci.B[be.all.summ$Species == 'Etrumeus acuminatus'],big.mark=",",digits=3)` t), and was observed entirely in the southernmost portion of the survey area surveyed by _`r survey.vessel`_ and _Carranza_. This was the first time the SWFSC's ATM survey has encountered Round Herring and estimated its biomass.  
...
**[KLS] This text has been present in the last several biomass reports. Revise to reflect latest results, particularly the general increase in biomass for the forage fish community, but particularly the resurgence and dominance of anchovy. Perhaps note that the NS of sardine remains low, and that the SS biomass is a significant part of the CPS community in the SCB.]**
