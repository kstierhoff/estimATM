...
(ref:sardine-potential-habitat) Distribution of potential habitat for the northern stock of Pacific Sardine, temporally aggregated using an average of the habitat centered ±2° around _`r survey.vessel`_ positions throughout the survey. Areas in white correspond to no available data, e.g., cloud coverage preventing satellite-sensed observations **[Get revised habitat map from J. Renfree]**.
...
The SWFSC's General Purpose Transceiver (38-kHz Simrad EK60 GPT) was connected to the vessel's hull-mounted split-beam transducer (ES38B; Kongsberg; not shown).  
