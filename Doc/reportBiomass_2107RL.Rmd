...
**Consider using different shades of red and green for each stock, and adding both stocks of sardine and anchovy to Figs 33 and 34. In the text, describe the different sampling areas for each survey, or limit the data to a common area, e.g. from Cape Flattery to San Diego(?). Thoughts?**
