...
(ref:cal-results-sd) Miniature Wide-Bandwidth Transceiver (WBT-Mini; Kongsberg) beam model results estimated from calibrations of echosounders aboard USVs, dockside, using a WC38.1.
...
##### _Carranza_
\
**Up to three trawls were conducted each night using similar a similar approach to _`r survey.vessel`_.**  
...
**[It is not clear what values are used for m and b (Eq. (5)), and what equations are used for mass as a function of length for each species in the derivations of Eqs. (6), (7), (8) and (9). DAD]**
