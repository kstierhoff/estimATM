...
In `r tolower(survey.season)` `r survey.year`, the ATM survey, spanning U.S. and Mexican waters, was conducted by _`r survey.vessel`_ was augmented with coordinated sampling by fishing vessels _Lisa Marie_, who sampled _`r survey.vessel`_'s transects between Cape Flattery and Cape Mendocino, to estimate biomasses of CPS in the core survey area, and by fishing vessels _Lisa Marie_ and _Long Beach Carnage_ to estimate the biomasses of CPS in the core and nearshore regions, where sampling by _`r survey.vessel`_ was not possible or safe. Two wind-powered uncrewed surface vessels (Explorer USVs; Saildrone, Inc.) conducted acoustic sampling along adaptive transects not sampled by _`r survey.vessel`_ or _Lisa Marie_ between Newport, OR and Bodega Bay.  

In `r tolower(survey.season)` `r survey.year`, the ATM survey, spanning U.S. and Mexican waters, was conducted by _`r survey.vessel`_, _Lisa Marie_, _Long Beach Carnage_, and two wind-powered uncrewed surface vessels (Explorer USVs; Saildrone, Inc.). _Lisa Marie_ sampled transects in the core area between Cape Flattery and Cape Mendocino; the USVs sampled interstitial transects in the core area, between Newport, OR and Bodega Bay;  _`r survey.vessel`_ and _Lisa Marie_ sampled the core area between Cape Mendocino and Bodega Bay; and _`r survey.vessel`_ alone sampled the core area from Bodega Bay to Punta Baja, Baja CA. _Lisa Marie_ and _Long Beach Carnage_ sampled CPS in the nearshore regions, where sampling by _`r survey.vessel`_ was not possible or safe, between Cape Flattery and Bodega Bay, and between Bodega Bay and San Diego and around Santa Cruz and Santa Catalina Islands, respectively. Two wind-powered uncrewed surface vessels (Explorer USVs; Saildrone, Inc.) conducted acoustic sampling along adaptive transects not sampled by _`r survey.vessel`_ or _Lisa Marie_.
...
This survey was conducted with the approval of the Secretaria de Relaciones Exteriores (SRE, Diplomatic note **CTC/1312/2021**), the Instituto Nacional de Estadística y Geografía (INEGI; Permit: EG0022022), and the Comisión Nacional de Acuacultura y Pesca (CONAPESCA; Permit: PPFE/DGOPA-048/22).  
...
Leg I on _`r survey.vessel`_ was cancelled for reasons outside of the SWFSC's control, so _Lisa Marie_ was directed to sample the transects between `r survey.landmark.n` to Bodega Bay, CA using 20-nmi spacing, including the the nearshore portions of those transects. Meanwhile USVs (SD-1076 and SD-1077) were directed to sample the interstitial transects, also spaced 20-nmi apart, from Newport, OR to San Francisco (cyan lines, **Fig. \@ref(fig:survey-plan)**). Leg II on _`r survey.vessel`_ **[...]**. Leg III on _`r survey.vessel`_ was delayed by 16 days for similar reasons, so the remaining four days were used to sample transects spaced 20-nmi apart, from San Diego northward into the Southern California Bight (SCB). During Leg IV on _`r survey.vessel`_, transects were sampled southward from Monterey, CA to `r survey.landmark.s`. To progress as far south as possible, compulsory transects off Baja CA were shortened to 30-nmi, and adaptive transects were omitted.  
...
trawl hauls, or hauls otherwise deemed unacceptable.  
...
In summer 2022, between Cape Flattery and Bodega Bay, _Lisa Marie_ sampled along acoustic transects to a depth of ~5 m. To estimate biomass in the corresponding nearshore region, acoustic intervals that occurred shallower than the 20 m isobath were assigned to nearshore strata and biomasses were estimated as usual. In the same region, acoustic intervals from core region transects that occurred shallower than 20 m were removed prior to post-stratification and biomass estimation.  
...
(ref:sardine-potential-habitat) Summary of all transects sampled throughout the survey by _`r survey.vessel`_ (red) and _Lisa Marie_ (yellow) in relation to the modeled potential habitat for the northern stock of Pacific Sardine [@Zwolinski2011]. The habitat-model output is averaged in areas, ±2° latitude and longitude, centered around the location of each vessel throughout the survey. Areas without data (white), occurred in the analysis domain where and when clouds prevented satellite-sensed observations.

```{r sardine-potential-habitat,fig.cap='(ref:sardine-potential-habitat)', out.width='7.5in',fig.pos='H'}
...
**[Please review this paragraph, which combined the existing paragraph and the third paragraph from the Discussion that mentioned the potential contribution of other CPS that could have been present in sets containing sardine in 2022.]**

Pacific Herring were predominant, by weight, in purse seine samples collected by _Lisa Marie_ north of the Columbia River (**Fig. \@ref(fig:sardine-jack-adjustment)e**). Between the Columbia River and Cape Mendocino, Pacific Sardine were predominant in the catch (**Fig. \@ref(fig:sardine-jack-adjustment)e**). On numerous occasions, however, Jack Mackerel were reportedly schooling with Pacific Sardine, but eluded capture, thereby biasing the species composition in those samples (K. Hinton, pers. comm.). Therefore, for the region between Astoria and Cape Mendocino, the acoustic proportions of Pacific Sardine in nighttime trawl catches from _`r survey.vessel`_ between 2018 and 2021 (**Fig. \@ref(fig:sardine-jack-adjustment)a-c**) were used to model **[Insert additional explanation from Juan]** their acoustic proportion versus latitude (**Fig. \@ref(fig:sardine-jack-adjustment)d**), which was used to estimate the acoustic proportion of Pacific Sardine in the purse-seine catch in 2022 (**Fig. \@ref(fig:sardine-jack-adjustment)f**). The complement acoustic proportion in the 2022 purse seine catch was assumed to be Jack Mackerel, based on the association of Jack Mackerel and Pacific Sardine in the summer 2021 nighttime trawl catches (**Fig. \@ref(fig:sardine-jack-adjustment)f**). Other species (e.g., Pacific Herring, Pacific Mackerel, saury, and smelt) that could have contributed to the CPS backscatter in this area were also observed or suspected to be avoiding the net (K. Hinton, pers. comm.), but those species comprised a small fraction (<5%, but typically <1%) of the acoustic proportions in clusters that contained both Pacific Sardine and Jack Mackerel in 2021. The Jack Mackerel lengths are those from the summer 2021 nighttime trawl catches nearest to the CPS backscatter. The purse seine was only deployed when schools were observed, so purse-seine sampling was sparse along portions of the WA and OR coast. Overall, the `r nrow(lm.sets)` seines captured a combined `r prettyNum(sum(seine.summ.lm$total.wt),big.mark=",",digits=3)` kg of CPS (`r prettyNum(seine.summ.lm$total.wt[seine.summ.lm$scientificName == "Sardinops sagax"],big.mark=",",digits=3)` kg of Pacific Sardine, `r prettyNum(seine.summ.lm$total.wt[seine.summ.lm$scientificName == "Trachurus symmetricus"],big.mark=",",digits=3)` kg of Jack Mackerel, `r prettyNum(seine.summ.lm$total.wt[seine.summ.lm$scientificName == "Clupea pallasii"],big.mark=",",digits=3)` kg of Pacific Herring, `r prettyNum(seine.summ.lm$total.wt[seine.summ.lm$scientificName == "Scomber japonicus"],big.mark=",",digits=3)` t of Pacific Mackerel, and `r prettyNum(seine.summ.lm$total.wt[seine.summ.lm$scientificName == "Engraulis mordax"],big.mark=",",digits=3)` kg of Northern Anchovy). 
...
```{r nasc-seine-lm, fig.cap='(ref:nasc-seine-lm)', out.height='8in', fig.pos='H', eval=FALSE}
...
(ref:nasc-prop-ns) Spatial distributions of: a) 38-kHz integrated backscattering coefficients ($s_A$, m^2^ nmi^-2^;  averaged over 2000-m distance intervals) ascribed to CPS from nearshore sampling; and b) acoustic proportions of CPS in purse seine and trawl samples. **[Check figure to ensure proper species proportions are being displayed; presently showing purse seine catch, by weight, which does not reflect adjustment of Sardine and Jack Mackerel proportions]**
...
**[Please review the paragraph below, which I just revised to incorporate the challenges associated with the loss of sea days. Since it seemed better placed in the Results, where we discussed the adjustment of catch proportions from Lisa Marie sampling, I moved the paragraph describing the contributions from "other" species in 2021 to that section, above.]**

Despite inclement weather conditions, mechanical limitations, staffing issues, and logistical challenges related to the COVID-19 pandemic, and the loss of nearly half of the allocated sea days aboard _`r survey.vessel`_, the core region was surveyed by _Lisa Marie_ and two USVs from Cape Flattery to Bodega Bay, and by _`r survey.vessel`_ between Cape Mendocino and El Rosario off Baja CA. Following the cancellation of Leg 1, the decision was made to forgo sampling off Vancouver Island to maximize the likelihood of surveying all of the transects in U.S. waters. To mitigate the loss of acoustic sampling effort north of Cape Mendocino, the decision was made to have _Lisa Marie_ and two USVs acoustically sample along _`r survey.vessel`_'s compulsory transects in tandem, and daytime purse-seine sampling was conducted by _Lisa Marie_ to provide information about the distribution, species composition, and length distribution of CPS. This approach deviated from the standard ATM surveys, which created additional challenges and uncertainty. For example, catch selectivity caused by net avoidance by fast-swimming species, such as Jack Mackerel, required novel methods to adjust species proportions in that region to minimize biases of biomass estimates.   

**[Discuss challenges faced by significant loss of sea days and changes to routine sampling approaches.]** Reference ICES Report **WKUSER2** [@ICES2023]. 
