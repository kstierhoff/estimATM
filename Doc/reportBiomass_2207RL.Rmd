...
The `r tolower(survey.season)` `r survey.year` survey was conducted principally using _`r survey.vessel`_ and _Lisa Marie_, but was augmented with acoustic sampling by two uncrewed surface vehicles (USVs). The sampling domain, or core region, between `r survey.landmark.n` and `r survey.landmark.s`, was defined by the conceptual distribution of potential habitat for the northern stock of Pacific Sardine in summer (**Fig. \@ref(fig:sardine-distribution)**), but also encompassed the anticipated distributions of the southern stock of Pacific Sardine and the central and northern stocks of Northern Anchovy off the west coasts of the U.S. and portion of Baja CA, Mexico. It also spanned portions of the Pacific Mackerel, Jack Mackerel, Pacific Herring, and Round Herring populations. East to west, the sampling domain extends from the coast to at least the 1,000 ftm (~1830 m) isobath (**Fig. \@ref(fig:survey-plan)**). Considering the expected distribution of the target species, the acceptable uncertainty in biomass estimates, and the available ship time (`r survey.das` days at sea, DAS), the principal survey objectives were the estimations of biomasses for the northern and southern stocks of Pacific Sardine and the northern and central stocks of Northern Anchovy in the survey region. Additionally, biomass estimates were sought for Pacific Mackerel, Jack Mackerel, Pacific Herring, and Round Herring if present in the survey region.  
...
After Leg I on _`r survey.vessel`_ was cancelled due to staffing issues, the plan was modified for _Lisa Marie_ to survey transects between `r survey.landmark.n` to Bodega Bay, CA using 20 nmi spacing. _Lisa Marie_ would then continue to sample the nearshore portions of the transects, albeit at the 20-nmi spacing instead of 10 nmi as originally planned. Meanwhile the USVs would survey interstitial to _Lisa Marie_ transects starting near Grays Harbor, WA and continuing as far south as time permitted. Further due to continued staffing issues, Leg III on _`r survey.vessel`_ was delayed by 16 days, so the plan was then modified to use the remaining four days of the leg to survey northward from San Diego, CA into the Southern California Bight (SCB) using 20 nmi spacing. Leg IV on _`r survey.vessel`_ would then resume sampling southward from Monterey Bay, CA to `r survey.landmark.s`.  

To increase the spatial sampling resolution, acoustic sampling was to be conducted by USVs (SD-1076 and SD-1077) on transects interstitial to _Lisa Marie_'s transects from Newport, OR to San Francisco (cyan lines, **Fig. \@ref(fig:survey-plan)**). **Adaptive transects were interstitial to compulsory transects off Baja CA. However, due to lost sea days and to maximize progress as far south as possible, compulsory transects off Baja CA were shortened to 30-nmi-long and adaptive sampling was not conducted.**  

To estimate the abundances and biomasses of CPS close to shore, in shallow water, or both, where _`r survey.vessel`_ and USVs could not efficiently or safely navigate or trawl, acoustic and purse seine sampling was to be conducted nearshore between Cape Flattery and San Diego using the two fishing vessels equipped with echosounders (magenta lines, **Fig. \@ref(fig:survey-plan)**). _Lisa Marie_ sampled transects to ~5-m depth, spaced 10 nmi apart between Cape Flattery and Bodega Bay. _Long Beach Carnage_ sampled 5-nmi-long transects spaced 5 nmi apart between Bodega Bay and San Diego, and 2.5-nmi-long transects spaced 2.5 nmi apart around Santa Cruz and Santa Catalina Islands in the SCB.  
...
On _Lisa Marie_, multi-frequency Wideband Transceivers (Simrad 38- and 200-kHz EK80 WBTs; Kongsberg) were connected to the vessel's hull-mounted split-beam transducers (Simrad ES38-7 and ES200-7C; Kongsberg).
...
On the three USVs (SD-1076 and SD-1077), miniature Wide-Bandwidth Transceivers (Simrad WBT-Mini; Kongsberg) were configured with gimbaled, keel-mounted, dual-frequency transducers (Simrad ES38-18|200-18C; Kongsberg) containing a split-beam 38-kHz transducer and single-beam 200-kHz transducer with nominally 18$^\circ$ beamwidths.  
...
(ref:cal-results-lm) Wideband Transceiver (Simrad EK80 WBT; Kongsberg) and transducer information (above horizontal line) and beam model results (below horizontal line) estimated from an in situ calibration of echosounders aboard _Lisa Marie_ using a WC38.1 standard sphere.
...
(ref:cal-results-lbc) General Purpose Transceiver (Simrad EK60 GPT; Kongsberg) and transducer information (above horizontal line) and beam model results (below horizontal line) estimated from a tank calibration of echosounders used aboard _Long Beach Carnage_ using a WC38.1 standard sphere.
...
For the two USVs, the echosounders were calibrated while dockside by Saildrone, Inc. using the standard sphere technique. The results were processed and derived by the SWFSC [@Renfree2019], and are presented in **Table \@ref(tab:cal-results-sd)**. 

(ref:cal-results-sd) Miniature Wideband Transceiver (Simrad-Kongsberg WBT Mini) beam model results estimated from calibrations of echosounders aboard USVs using a WC38.1 standard sphere. 
...
After sunset, CPS schools tend to ascend and disperse and are less likely to avoid a trawl net [@Mais1977]. Therefore, trawling was conducted during the night to better sample the fish aggregations dispersed near the surface to obtain information about species composition, lengths, and weights of fishes observed in the echosounders mounted aboard _`r survey.vessel`_ during the day.  

**During the day, CPS schools close to shore aggregate and their vertical distribution is constrained by the depth of the seabed, thereby facilitating their capture using purse seines. Therefore, purse seine nets were set during the day in the nearshore region to provide information about species composition, lengths, and weights of fishes observed in the echosounders mounted on the fishing vessels.**
...
On _Lisa Marie_, as many as three purse seine sets were planned each day. For each set, three dip net samples, spatially separated as much as possible, were collected.  

On _Long Beach Carnage_, as many as three purse seine sets were conducted each day, including evenings. The total weight (tons) of the school was estimated by the captain. For each set, three dip net samples, spatially separated as much as possible, were collected.  
...
When necessary, the start and stop integration lines were manually edited to exclude reverberation due to bubbles, to include the entirety of shallow CPS aggregations, or to exclude seabed echoes. Also, echoes suspected to be from rockfish schools were excluded.  
...
Leg I on _`r survey.vessel`_ was canceled due to staffing issues. _Lisa Marie_ was therefore directed to sample the Leg I 20-nmi-spaced compulsory transects in lieu of its nearshore transects, but extending them shoreward to ~5-nmi depth. _Lisa Marie_ sampled Transects 178 to 143 between Cape Flattery, WA to Port Orford, OR, from 6 to 20 July. Two USVs (SD-1076 and SD-1077) sampled Transects 170 to 160, between Copalis Beach, WA to Tillamook Bay, OR, from 9 to 22 July.
...
_Lisa Marie_ sampled core-region Transects 141 to 114, between Cape Sebastian, OR to Bodega Bay, CA, from 21 July to 1 August. On 2 August, on its transit north, _Lisa Marie_ resampled Transect 133, which had previously been sampled during Leg II but without recording EK80 data. On 3 August, _Lisa Marie_ returned to Westport, WA to conclude its portion of the 2022 Summer CCE survey.
...
Acoustic backscatter ascribed to CPS was observed throughout the latitudinal range of the core survey area (**Fig. \@ref(fig:nasc-cufes-trawl)a**) and was present from near the coast to the shelf break. Zero-biomass intervals were observed at the offshore end of each transect in the core region. The majority (greater than `r cum.biomass.limit*100`%) of the biomass for each species was apportioned using catch data from trawl clusters conducted within 30 nmi (**Fig. \@ref(fig:biomass-cluster-distance)**).  
...
**[Should the description of the sardine-jack adjustment be included as a section in the Methods? instead of here in the Results? YES! but could be reiterated here]**

Pacific Herring were predominant, by weight, in purse seine samples collected by _Lisa Marie_ north of the Columbia River (**Fig. \@ref(fig:sardine-jack-adjustment)a**). Between the Columbia River and Cape Mendocino, Pacific Sardine were predominant in the catch (**Fig. \@ref(fig:sardine-jack-adjustment)a**), but there were also many observations of Jack Mackerel schools when few or none were present in the catch. Therefore, for the region between approximately Astoria and Cape Mendocino, the acoustic proportions of Pacific Sardine in nighttime trawl catches from _`r survey.vessel`_ between 2018 and 2021 (**Fig. \@ref(fig:sardine-jack-adjustment)b-d**) were used to model the relationship between Pacific Sardine acoustic proportion versus latitude (**Fig. \@ref(fig:sardine-jack-adjustment)e**), which was then used to estimate a proxy for the acoustic proportion of Pacific Sardine in the purse seine catch in 2022 (**Fig. \@ref(fig:sardine-jack-adjustment)f**). The complement acoustic proportion in the 2022 purse seine catch was assumed to be Jack Mackerel, based on the association of Jack Mackerel and Pacific Sardine in the summer 2021 nighttime trawl catches (**Fig. \@ref(fig:sardine-jack-adjustment)e**). The Jack Mackerel lengths are from the summer 2021 nighttime trawl catches nearest the CPS backscatter. The purse seine was only deployed when schools were present, so purse seine sampling was sparse along portions of the WA and OR coast (**Fig. \@ref(fig:sardine-jack-adjustment)d**). Overall, the `r nrow(lm.sets)` seines captured a combined `r prettyNum(sum(seine.summ.lm$total.wt),big.mark=",",digits=3)` kg of CPS (`r prettyNum(seine.summ.lm$total.wt[seine.summ.lm$scientificName == "Sardinops sagax"],big.mark=",",digits=3)` kg of Pacific Sardine, `r prettyNum(seine.summ.lm$total.wt[seine.summ.lm$scientificName == "Trachurus symmetricus"],big.mark=",",digits=3)` kg of Jack Mackerel, `r prettyNum(seine.summ.lm$total.wt[seine.summ.lm$scientificName == "Clupea pallasii"],big.mark=",",digits=3)` kg of Pacific Herring, `r prettyNum(seine.summ.lm$total.wt[seine.summ.lm$scientificName == "Scomber japonicus"],big.mark=",",digits=3)` t of Pacific Mackerel, and `r prettyNum(seine.summ.lm$total.wt[seine.summ.lm$scientificName == "Engraulis mordax"],big.mark=",",digits=3)` kg of Northern Anchovy). 
...
(ref:sardine-jack-adjustment)  **Insert figure caption for revised figure here: a) Unadjusted purse seine catch; b-d) observed catch from 2018-2021; e) smoothed abundance; f) adjusted proportions used to estimate biomass.**
...
**On numerous occasions, _Lisa Marie_ reported the presence of Jack Mackerel occurring with Pacific Sardine but they eluded capture, thereby biasing the species composition. Therefore, for purse seine sets containing Pacific Sardine, the proportion of Pacific Sardine was estimated from the proportion of Pacific Sardine in nighttime trawl net catches at the same latitude between 2018 and 2021, but length distributions came from daytime purse seine catch in 2022. In those same sets, Jack Mackerel were assumed to comprise the remainder of the catch, and the length distributions of Jack Mackerel in the nearest nighttime trawl clusters in 2021 were used to estimate their length distribution. Other species (e.g., Pacific Herring, Pacific Mackerel, saury, and smelt) that could have contributed to the CPS backscatter in this area were also observed or suspected to be avoiding the net (K. Hinton, pers. comm.), but those species comprised a small fraction (<5%, but typically <1%) of the catch in clusters that contained both Pacific Sardine and Jack Mackerel in 2021.**  
...
The estimated biomass of the southern stock of Pacific Sardine in the survey region was `r prettyNum(be.all.summ$Biomass[be.all.summ$Species == "Sardinops sagax" & be.all.summ$Stock == "Southern"], big.mark=",", digits = 5)` t (CI~95%~ = `r prettyNum(be.all.summ$lower.ci.B[be.all.summ$Species == "Sardinops sagax" & be.all.summ$Stock == "Southern"], big.mark=",",digits=5)` - `r prettyNum(be.all.summ$upper.ci.B[be.all.summ$Species == "Sardinops sagax" & be.all.summ$Stock == "Southern"],big.mark=",",digits=5)` t). In summer 2022 **[REVISE CALCULATIONS]**, `r prettyNum(sum(be.sar.s$Biomass[be.sar.s$Stratum %in% c(2)]), big.mark=",", digits = 5)` t (stratum 2; `r prettyNum(sum(be.sar.s$Biomass[be.sar.s$Stratum %in% c(2)])/sum(be.sar.s$Biomass)*100, big.mark=",", digits = 1)`% of the total biomass) of southern stock biomass was observed in U.S. waters, and the remaining `r prettyNum(sum(be.sar.s$Biomass[be.sar.s$Stratum ==1]), big.mark=",", digits = 5)` t (stratum 1; `r prettyNum(sum(be.sar.s$Biomass[be.sar.s$Stratum ==1])/sum(be.sar.s$Biomass)*100, big.mark=",", digits = 1)`% of the total biomass) was observed off Baja CA. The southern stock was first observed in U.S. waters by the SWFSC's ATM surveys in 2016 [`r prettyNum(biomass.pct.sar.s$biomass[biomass.pct.sar.s$year == 2016],big.mark=",", digits = 1)` t, @Stierhoff2021b]. **Of the portion in U.S. waters, `r prettyNum(be.all.ns$Biomass[be.all.ns$Species == "Sardinops sagax" & be.all.ns$Stock == "Southern"], big.mark=",", digits = 5)` t (`r prettyNum(be.all.ns$Biomass[be.all.ns$Species == "Sardinops sagax" & be.all.ns$Stock == "Southern"]/be.all.summ$Biomass[be.all.summ$Species == "Sardinops sagax" & be.all.summ$Stock == "Southern"]*100, big.mark=",", digits = 1)`%) occurred in the nearshore region.** Southern stock biomass in U.S. waters has been increasing in recent years, from `r prettyNum(biomass.pct.sar.s$biomass[biomass.pct.sar.s$year == 2018],big.mark=",", digits = 1)` t in summer 2018 [@Stierhoff2019b] to `r prettyNum(be.all.summ$Biomass[be.all.summ$Species == "Sardinops sagax" & be.all.summ$Stock == "Southern"], big.mark=",", digits = 5)` t in summer 2022.    
