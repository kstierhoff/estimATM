...
author:
  - K.L. Stierhoff, NOAA Fisheries-Southwest Fisheries Science Center
  - J.S. Renfree, NOAA Fisheries-Southwest Fisheries Science Center
  - J.P. Zwolinski, UCSC, Cooperative Institute for Marine, Earth, & Atmospheric Systems
  - D.A. Demer, NOAA Fisheries-Southwest Fisheries Science Center
...
Leg I on _`r survey.vessel`_ was cancelled due to staffing issues, so _Lisa Marie_ was directed to sample the transects between `r survey.landmark.n` to Bodega Bay, CA using 20-nmi spacing, including the the nearshore portions of those transects. Meanwhile USVs (SD-1076 and SD-1077) were directed to sample the interstitial transects, also spaced 20-nmi apart, from Newport, OR to San Francisco (cyan lines, **Fig. \@ref(fig:survey-plan)**). Leg II on _`r survey.vessel`_ **[...]** . Leg III on _`r survey.vessel`_ was delayed by 16 days due to continued staffing issues, so the remaining four days were used to sample transects spaced 20-nmi apart, from San Diego northward into the Southern California Bight (SCB). During Leg IV on _`r survey.vessel`_, transects were sampled southward from Monterey, CA to `r survey.landmark.s`. To progress as far south as possible, compulsory transects off Baja CA were shortened to 30-nmi, and adaptive transects were omitted.  
...
Leg I on _`r survey.vessel`_ was canceled due to staffing issues. Therefore, , _Lisa Marie_ was directed to sample the 20-nmi-spaced compulsory Transects, 178 to 143, between Cape Flattery and Port Orford, OR, but extending them shoreweard to ~5 m depth. Two USVs (SD-1076 and SD-1077) sampled Transects 170 to 160, between Copalis Beach, WA to Tillamook Bay, OR, from 9 to 22 July.
...
**[Discuss challenges faced by significant loss of sea days and changes to routine sampling approaches.]**
...
**[Insert revised statistics and furher revise this paragraph]** The biomass of the central stock of Northern Anchovy, which had been growing exponentially since 2015, declined **XX**% from its value of **2,XXX,XXX t** in summer 2021. Jack Mackerel, which were found mostly north of Cape Mendocino, included an abundance of apparently age-0 fish farther south, suggesting a strong recruitment. The southern stock of Pacific Sardine was found mostly north of the U.S.-Mexico border and nearshore. Even considering the additional uncertainties in the biomass estimates north of Cape Mendocino (see **Section \@ref(results-seine-catch-lm) and nearshore-extraction**) there is no indication that the biomasses of the northern stock of Pacific Sardine and the northern stock of Northern Anchovy have increased significantly since summer 2021.
