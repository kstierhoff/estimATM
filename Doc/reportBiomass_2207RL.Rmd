...
The planned core survey region, which was to be sampled by NOAA ship _`r survey.vessel.long`_ (hereafter, _`r survey.vessel`_) and two wind-powered uncrewed surface vehicles (Explorer USVs; Saildrone, Inc.), spanned most of the continental shelf between `r survey.landmark.n` and `r survey.landmark.s`. However, after an unprecedented loss of sea days due to insufficient staffing aboard _`r survey.vessel`_, the plan was modified for _Lisa Marie_ to survey _`r survey.vessel`_'s transects between `r survey.landmark.n` to Bodega Bay, CA using 20 nmi spacing. Throughout the core region, _`r survey.vessel`_, _Lisa Marie_, and the two USVs sampled along transects oriented approximately perpendicular to the coast, from the shallowest navigable depth (~25 m) to either a distance of 35 nmi or to the 1,000 ftm (~1830 m) isobath, whichever is farthest. In the SCB, transects in the core region were extended to approximately 75 nmi. Between Cape Mendocino and Punta Baja, species composition and length distributions of CPS scatters were informed by the catches from a surface trawl towed at the surface at night. North of Cape Mendocino, where _`r survey.vessel`_ did not sample, species composition and length distributions of CPS scatters were informed by the catches from a purse seine set during the day, but adjusted to reflect associations between Pacific Sardine and Jack Mackerel in this region during summer from 2018-2021 (**see Section X.X.X**).  

Because sampling by _`r survey.vessel`_ and USVs in water shallower than ~25 m was deemed inefficient, unsafe, or both, fishing vessels _Lisa Marie_ and _Long Beach Carnage_ were used to estimate the biomass of CPS in the nearshore region of U.S. waters. The vessels sampled along 5 nmi-long transects spaced 5 nmi apart off the mainland coast of the U.S. between `r survey.landmark.n` and San Diego, CA, as well as around Santa Cruz and Santa Catalina Islands in the Southern CA Bight. **The species composition and length distributions of CPS scatters in the nearshore region were informed by the catches from a purse seine set by the fishing vessels during the day or a trawl towed by _`r survey.vessel`_ at night, whichever was nearest.**  
