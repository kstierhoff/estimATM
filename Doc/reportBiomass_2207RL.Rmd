...
Pacific Herring were predominant, by weight, in purse seine samples collected by _Lisa Marie_ north of the Columbia River (**Fig. \@ref(fig:sardine-jack-adjustment)e**). Between the Columbia River and Cape Mendocino, Pacific Sardine were predominant in the catch (**Fig. \@ref(fig:sardine-jack-adjustment)e**), but there were also many observations of Jack Mackerel schools when few or none were present in the catch (K. Hinton, pers. comm.). Therefore, for the region between Astoria and Cape Mendocino, the acoustic proportions of Pacific Sardine in nighttime trawl catches from _`r survey.vessel`_ between 2018 and 2021 (**Fig. \@ref(fig:sardine-jack-adjustment)a-c**) were used to model **[Insert additional explanation from Juan]** their acoustic proportion versus latitude (**Fig. \@ref(fig:sardine-jack-adjustment)d**), which was used to estimate the acoustic proportion of Pacific Sardine in the purse-seine catch in 2022 (**Fig. \@ref(fig:sardine-jack-adjustment)f**). The complement acoustic proportion in the 2022 purse seine catch was assumed to be Jack Mackerel, based on the association of Jack Mackerel and Pacific Sardine in the summer 2021 nighttime trawl catches (**Fig. \@ref(fig:sardine-jack-adjustment)f**). The Jack Mackerel lengths are those from the summer 2021 nighttime trawl catches nearest to the CPS backscatter. The purse seine was only deployed when schools were observed, so purse-seine sampling was sparse along portions of the WA and OR coast (**Fig. \@ref(fig:sardine-jack-adjustment)e**). Overall, the `r nrow(lm.sets)` seines captured a combined `r prettyNum(sum(seine.summ.lm$total.wt),big.mark=",",digits=3)` kg of CPS (`r prettyNum(seine.summ.lm$total.wt[seine.summ.lm$scientificName == "Sardinops sagax"],big.mark=",",digits=3)` kg of Pacific Sardine, `r prettyNum(seine.summ.lm$total.wt[seine.summ.lm$scientificName == "Trachurus symmetricus"],big.mark=",",digits=3)` kg of Jack Mackerel, `r prettyNum(seine.summ.lm$total.wt[seine.summ.lm$scientificName == "Clupea pallasii"],big.mark=",",digits=3)` kg of Pacific Herring, `r prettyNum(seine.summ.lm$total.wt[seine.summ.lm$scientificName == "Scomber japonicus"],big.mark=",",digits=3)` t of Pacific Mackerel, and `r prettyNum(seine.summ.lm$total.wt[seine.summ.lm$scientificName == "Engraulis mordax"],big.mark=",",digits=3)` kg of Northern Anchovy). 
...
Despite inclement weather conditions, mechanical limitations, staffing issues, and logistical challenges related to the COVID-19 pandemic, the core region was surveyed by _Lisa Marie_ and two USVs from Cape Flattery to Bodega Bay, and by _`r survey.vessel`_ between Cape Mendocino and El Rosario off Baja CA.  
...
On numerous occasions, _Lisa Marie_ reported Jack Mackerel schooling with Pacific Sardine, but eluding capture, thereby biasing the species composition. Therefore, purse-seine catches containing Pacific Sardine were assigned the proportion of Pacific Sardine estimated from a model of Pacific Sardine catch proportions versus latitude, derived from nighttime trawl catches between 2018 and 2021. The Pacific Sardine length distributions were from the daytime purse-seine catch in 2022. In those same sets, Jack Mackerel were assumed to comprise the remainder of the catch, and their lengths were assigned those from the nearest nighttime trawl clusters in 2021. Other species (e.g., Pacific Herring, Pacific Mackerel, saury, and smelt) that could have contributed to the CPS backscatter in this area were also observed or suspected to be avoiding the net (K. Hinton, pers. comm.), but those species comprised a small fraction (<5%, but typically <1%) of the catch in clusters that contained both Pacific Sardine and Jack Mackerel in 2021.  
...
Since 2016, the forage-fish biomass has increased, mainly due to resurgences of Jack Mackerel and the now dominant central stock of Northern Anchovy (**Figs. \@ref(fig:biomass-ts-line), \@ref(fig:biomass-ts-bar)**), whose biomass primarily (`r prettyNum(be.anch.c$Biomass[be.anch.c$Stratum == 3],big.mark=",",digits=3)` t, or `r round(be.anch.c$Biomass[be.anch.c$Stratum == 3]/sum(be.anch.c$Biomass)*100)`% of the total estimate biomass) occurred in U.S. waters. Between the summers of 2018 and 2021, the biomass of the southern stock of Pacific Sardine in U.S. waters has increased from 33,093 to `r prettyNum(sum(be.sar.s$Biomass[be.sar.s$Stratum %in% c(2)]+be.all.ns$Biomass[be.all.ns$Species == 'Sardinops sagax' & be.all.ns$Stock == "Southern"]), big.mark=",", digits = 5)` t.  

**[Ensure that all of the information in our contribution to the CCEIA report is included here.]**

\newpage

(ref:biomass-ts-line) Estimated biomasses ($t$) of the `r num2words(n_distinct(biomass.ts$group))` most abundant CPS stocks of `r num2words(n_distinct(biomass.ts$species))` species in the CCE during summer since 2008. Surveys typically span the area between Cape Flattery and San Diego, but in some years also include Vancouver Island, Canada (2015-2019) and portions of Baja CA (2021-2022). Error bars are 95% confidence intervals. **[Since the proliferation of CSNA, the less abundant stocks are no longer visible in this plot, without changing line types and shapes. If it doesn't add information to the subsequent plot, should it be removed?]**
