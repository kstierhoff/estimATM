...
The biomasses, distributions, and demographics for each species and stock are for the survey area and period, and therefore may not represent their entire population or stock. Sampling was conducted in the core and nearshore regions off Baja CA by INAPESCA, but the estimates in this report are for U.S. waters only.  
...
On _Lisa Marie_, multi-frequency Wideband Transceivers (Simrad `r echo.freqs.dash["LM"]`kHz Simrad EK80 WBTs; Kongsberg) were connected to the vessel's hull-mounted split-beam transducers (Simrad `r echo.models["LM"]`; Kongsberg). The transducers were at a water depth of ~4 m.  
...
The net catches provide information about species composition, lengths, weights and ages of CPS sampled acoustically during the day. Nighttime trawls were conducted to sample the fish dispersed in the upper ~15 m of the sea surface, because after sunset, schools of CPS and other fish tend to ascend and disperse and are less likely to avoid a trawl net [@Mais1977]. Beginning in the summer of 2023, and when weather conditions were favorable, the trawl net was towed along an arced path so that the net fished outside of the ship's wake [@Nottestad2015]. Daytime purse-seine nets were set nearshore to sample CPS schools where their depth is constrained by the seabed and their vision is obscured by turbidity due to primary production and suspended particulates.  
...
_Lisa Marie_ used an approximately 440-m-long and 40-m-deep net with 17-mm-wide mesh (A. Blair, pers. comm.). _Long Beach Carnage_ used an approximately 200-m-long and 27-m-deep net with 17-mm-wide mesh; a small section on the back end of the net had 25-mm-wide mesh (R. Ashley, pers. comm.). Specimens collected by _Lisa Marie_ were processed aboard the vessel by the WA Department of Fish and Wildlife (WDFW; see see **Section \@ref(methods-seine-processing-lm)**) and specimens collected aboard _Long Beach Carnage_ were processed ashore by the CA Department of Fish and Wildlife (CDFW; see **Section \@ref(methods-seine-processing-lbc)**)).  
...
### Correction of deep backscatter in the nearshore region  

In summer 2023, the majority of backscatter observed in the nearshore region in the SCB was deeper than the thermocline, which based on CTD casts conducted in the region, was at a depth of approximately 30 m. However, purse-seine samples in the same area was largely comprised of Pacific Sardine, which typically occur above the thermocline, so it was theorized that the deep backscatter was due to the presence of Northern Anchovy that were present but probably underrepresented in purse-seine samples. Therefore, backscatter shallower than 30 m was apportioned using the length and species composition of all CPS in the nearest purse-seine sample, while all backscatter deeper than 30 m was assumed to be Northern Anchovy and apportioned using the length composition of Northern Anchovy in the nearest purse-seine sample where Northern Anchovy were collected. Then, biomass was estimated using the same method as other regions and years. 
...
>From 8 to 18 July, _Long Beach Carnage_ sampled nearshore transects 001 to 038, between San Diego, CA to Point Conception, CA, including around the Santa Catalina and Santa Cruz Islands.

>From 22 to 25 July, _Lisa Marie_ conducted purse seine sets for comparative catch analyses between Point Conception, CA and Monterey Bay, CA.

>From 21 to 30 July, two USVs (SD-1060 and SD-1096) sampled transects 052 to 070, from Point Conception, CA to Half Moon Bay, CA.
...
>From 7 to 16 August, _Long Beach Carnage_ sampled nearshore transects 039 to 090, from Point Conception, CA to Bodega Bay, CA.  

>From 6 to 8 August, _Lisa Marie_ conducted purse seine sets for comparative catch analyses between Point Conception, CA and San Luis Obispo, CA. Then, from 11 August to 2 September, _Lisa Marie_ sampled nearshore transects 091 to 216, from Bodega Bay, CA to Cape Flattery, WA.  

>From 10 to 29 August, The three USVs sampled transects 072 to 100, from Half Moon Bay, CA to Crescent City, CA.
...
(ref:nasc-cufes-trawl) Spatial distributions of: a) 38-kHz integrated backscattering coefficients ($s_A$, m^2^ nmi^-2^;  averaged over 2000-m distance intervals) ascribed to CPS; b) CUFES egg density (eggs m^-3^) for Northern Anchovy, Pacific Sardine, and Jack Mackerel; and c) acoustic proportions of CPS in trawl clusters. Black points indicate trawl clusters with no CPS.
