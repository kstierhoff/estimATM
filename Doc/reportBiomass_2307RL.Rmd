...
**[RESUME HERE; check for backslash error]**

On _Lisa Marie_, as many as **three** purse-seine sets were conducted each day, including evenings. For each set, three dip-net samples, were collected, spatially separated as much as possible.  

On _Long Beach Carnage_, as many as **three** purse-seine sets were conducted each day, including evenings. For each set, three dip-net samples were collected, spatially separated as much as possible.  **[If truly the same, can combine into one sentence.]**
