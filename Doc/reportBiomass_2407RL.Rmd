...
**[Describe results of comparative sampling.]** 
Catch comparisons: **Fig. \@ref(fig:trawl-seine-comparison-haul)** or **Fig. \@ref(fig:trawl-seine-comparison-cluster)**.

Length comparisons: **Fig. \@ref(fig:trawl-seine-comparison-lengths)**

(ref:trawl-seine-comparison-haul) The proportion of CPS (by weight) in nighttime a) trawls and b) purse seines.
...
(ref:trawl-seine-comparison-cluster) The proportion of CPS (by weight) in nighttime a) trawl clusters and b) purse seines.
...
(ref:trawl-seine-comparison-lengths) **[UPDATE]** Estimated abundance (upper panel) and biomass (lower panel) versus fork length ($L_F$, cm) for Round Herring (_Etrumeus acuminatus_) in the core survey region. No Round Herring were caught in the nearshore region.

```{r trawl-seine-comparison-lengths,eval=TRUE,fig.cap='(ref:trawl-seine-comparison-lengths)',out.width='8in',fig.pos='H'}

# Add catch comparison figure
include_graphics(here("Figs/fig_trawl_seine_lengths_comp.png"))  
``` 
