...
In some areas, substantial backscatter was observed deeper than the upper mixed layer (approximately 30-m deep) in the nearshore region. In those areas, the purse-seine catches sampled using a 27-m deep net contained mostly Pacific Sardine, which typically reside above the thermocline (J. Zwolinski, unpublished data), but also Northern Anchovy. Therefore, the CPS backscatter shallower than 30 m was apportioned using the length and species composition of all CPS in the nearest purse seine sample or trawl cluster; **backscatter attributed to Northern Anchovy deeper than 30 m has not yet been used to estimate biomass [this will be done prior to publication; this process should only result in an increase in the biomass of CSNA in the nearshore region, and not affect the nearshore biomasses of other species or subpopulations].**   

<!-- CPS backscatter deeper than 30 m was assumed to be Northern Anchovy with length compositions corresponding to the nearest purse-seine set or trawl cluster containing Northern Anchovy.   -->
