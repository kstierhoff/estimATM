...
From 31 August to 6 September, _Lisa Marie_ conducted nighttime purse seine sampling in areas where CPS backscatter was observed earlier that day, and where _`r survey.vessel`_ conducted nighttime trawling on the same evening (**Fig.** \@ref(fig:trawl-seine-comp-map)). 

**[Describe comparative trawl/seine sampling]** 

\newpage

(ref:trawl-seine-comp-map) Locations of nighttime trawls (black lines) and purse seine sets (red points) for catch comparisons.
...
(ref:trawl-seine-comparison-haul) **[UPDATE]** Estimated abundance (upper panel) and biomass (lower panel) versus fork length ($L_F$, cm) for Round Herring (_Etrumeus acuminatus_) in the core survey region. No Round Herring were caught in the nearshore region.
