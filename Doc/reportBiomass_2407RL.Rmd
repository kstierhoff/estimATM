...
In some areas, substantial backscatter was observed deeper than the upper mixed layer (approximately 30-m deep) in the nearshore region. In those areas, the purse-seine catches sampled using a 27-m deep net contained mostly Pacific Sardine, which typically reside above the thermocline (J. Zwolinski, unpublished data), but also Northern Anchovy. Therefore, the CPS backscatter shallower than 30 m was apportioned using the length and species composition of all CPS in the nearest purse seine sample or trawl cluster and used to estimate biomass density. CPS backscatter deeper than 30 m was assumed to be Northern Anchovy or Pacific Herring with length compositions corresponding to the nearest purse-seine set or trawl cluster containing either or both of those two species and used to estimate biomass density. Biomass densities from the two depth strata were summed vertically and used to estimate biomass.  
