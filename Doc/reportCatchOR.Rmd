...
get.db         <- T
get.nav        <- F
sampling.cufes <- T # Were CUFES data collected?
...
write_csv(specimens.or, file = here("Output/specimen_info_OR.csv"))
...
write_csv(specimen.summ, here("Output/specimen_table_ODFW.csv"), na = "")
```
...
if (sampling.cufes) {
  ...
  cufes.all %>% 
    ...
    write_csv(here("Output/cufes_table_ODFW.csv"))
} else {
