...
A map showing all trawl hauls (black points), trawls in WA State waters (red points), and trawls occurring in WA MPAs (blue markers; **need WA MPA shapefiles, if any**). Hovering over shaded polygons will show MPA names, and over points will show the trawl "key", which includes the cruise, ship, haul, and collection.  
