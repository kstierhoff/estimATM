...
if (do.spatial) {
  ...
  if (exists("sets")) {
    ...
    save(sets.ca, sets.mpa, sets.out, file = here("Output/set_data_reportCatch.Rdata"))  
  }
  ...
  if (file.exists(here("Output/set_data_reportCatch.Rdata"))) {
    load(here("Output/set_data_reportCatch.Rdata"))
  }
}
```
