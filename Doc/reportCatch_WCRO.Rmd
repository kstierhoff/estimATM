...
if (get.seine) {
  ...
  save(sets, set.catch, set.lengths,
       file = here("Data/Seine/seine_data_WCRO.Rdata"))
} else {
  if (file.exists(here("Data/Seine/seine_data_WCRO.Rdata"))) {
    load(here("Data/Seine/seine_data_WCRO.Rdata"))
  }
}
```
...
if (exists("set.catch")) {
  ...
  # Rename columns
  names(catch.set.summary) <- c("Scientific Name","Common Name",
                                "Total weight (kg)","Total number (n)")
