...
+ Industry vessels extended the echosounder and net-catch data to nearshore areas where _`r survey.vessel`_ could not safely navigate or trawl. With coordination, the sampling from _`r survey.vessel`_ was concomitant with sampling from Lisa Marie off WA and OR, and from Long Beach Carnage off SCB.  
