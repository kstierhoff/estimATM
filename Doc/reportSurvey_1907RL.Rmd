...
nasc.summ.sd.os  <- filter(nasc.summ.os, vessel.name == "SD")
```


## Data collection {#results-data-collection}
### Acoustic and trawl sampling {#results-acoustic-trawl-sampling}
The survey spanned an area from approximately `r survey.landmark.n`, to `r survey.landmark.s` (**Fig. \@ref(fig:station-sampling)**), with `r nrow(nasc.summ)` east-west transects totaling `r sprintf("%.0f",sum(nasc.summ$distance))` nmi, and `r nrow(trawl.summ)` Nordic trawls. **[Add summary statistics for offshore USV]**  
