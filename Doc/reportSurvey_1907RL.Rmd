...
The objectives for the survey were to: 1) acoustically map the distributions and estimate the abundances of CPS, i.e., Pacific Sardine _Sardinops sagax_, Northern Anchovy _Engraulis mordax_, Pacific Herring _Clupea pallasii_, Pacific Mackerel _Scomber japonicus_, and Jack Mackerel _Trachurus symmetricus_; and krill (euphausiid spp.); 2) characterize their biotic and abiotic environments, and investigate linkages; 3) gather information regarding their life histories; and 4) further evaluate the use of industry fishing vessels and unmanned surface vehicles (USVs) to augment the sampling from NOAA ships, particularly in nearshore areas where sampling using the larger NOAA ships is difficult or impossible (**Fig. \@ref(fig:vessel-pic)**).  
...
This report provides an overview of the survey objectives and a summary of the survey equipment, acoustic-system calibration, sampling and analysis methods, and preliminary results. This report does not include estimates of the distributions and biomasses of CPS or krill. Advantages and disadvantages to the combination of NOAA ships, industry vessels, and USVs are discussed from the SWFSC perspective.  

(ref:vessel-pic) NOAA Ship _`r survey.vessel`_ (left), F/V _Lisa Marie_ (top right), F/V _Long Beach Carnage_ (middle right), and Saildrone unmanned surface vehicle (USV, bottom right).

```{r vessel-pic, fig.cap='(ref:vessel-pic)', out.height='3.5in', fig.pos='H'}
include_graphics(here("Images/img_vessels_wide_1907RL.jpg"))
```
...
The planned transects (**Fig. \@ref(fig:survey-plan)**) spanned the latitudinal extent of the potential habitat of the northern stock of Pacific Sardine^[http://swfscdata.nmfs.noaa.gov/AST/sardineHabitat/habitat.asp] at the time of the survey (**Fig. \@ref(fig:sardine-habitat)**). Transect positions, lengths, and spaces were adaptively adjusted during the survey according to the observed distribution of putative CPS backscatter in the echosounders, CPS eggs in CUFES, or CPS landed in trawls. To estimate CPS biomass in offshore waters not routinely sampled during CCE surveys, sampling was also conducted by _`r survey.vessel`_ and two USVs along ~100 nmi-long extensions of compulsory transects spaced ~80 nmi-apart between approximately Florence, OR and San Diego. To estimate CPS biomass in nearshore waters where sampling by NOAA ships is difficult or impossible, _`r survey.vessel`_ coordinated sampling with two industry vessels that conducted acoustic and purse seine sampling in nearshore waters off the coast of WA and OR (F/V _Lisa Marie_) and in the Southern CA Bight along the mainland coast and around the northern Channel Islands (F/V _Long Beach Carnage_).  
...
A CalCOFI bongo oblique net [or bongo; a paired, bridleless, 71-cm diameter net with 505-$\mu$m mesh; @Smith1977] was used to opportunistically sample ichthyoplankton and krill soon after sunset. Where there was adequate depth, 300 m of wire was deployed at a rate of 50 m min^-1^ and then retrieved at 20 m min^-1^, at a nominal wire angle of 45$^\circ$. Bongo samples were stored in 5% buffered formalin.  
...
Nearshore acoustic sampling was conducted along ~5 nmi-long transects spaced ~5 nmi-apart to provide direct estimates of CPS biomass in shallow, nearshore waters where sampling by _`r survey.vessel`_ was not possible. During Legs I and IV, _`r survey.vessel`_ coordinated sampling with two industry fishing vessels, F/V _Lisa Marie_ and _Long Beach Carnage_, that conducted acoustic and purse seine sampling off the coast of WA and OR and in the Southern CA Bight, respectively. Throughout much of the survey, one USV conducted acoustic sampling between Cape Flattery, WA and San Francisco. Details of those surveys are presented in **Appendix \@ref(appendix-nearshore)**.  
...
(ref:station-sampling) The locations of surface trawls (white points); CTD and UCTD casts (red circles); and bongo net samples (orange triangles) relative to the east-west acoustic transects (black lines) and cruise track of _`r survey.vessel`_ (heavy gray line).
...
**[Elaborate and add additional points.]**

## Advantages  
+ USVs sampling offshore acoustic transects where wind was ample provided coincident sampling with _`r survey.vessel`_ and greatly increased the colletion of acoustic backscatter data throughout much of the survey area;
+ **Industry vessels...**
...
We thank the crew members of NOAA Ship _`r survey.vessel`_, as well as the scientists and volunteer technicians that participated in the sampling operations at sea. Critical reviews by **Reviewer A** and **[Others?]** improved this report.  

+ Capts. Ricky Blair and Greg Shaughnessy (_Lisa Marie_)
+ Capts. X and Y (_Long Beach Carnage_)
+ WDFW biologists who processed _LM_ samples
+ Diane Pleschner-Steele for...
+ Others who processed _LBC_ samples?
