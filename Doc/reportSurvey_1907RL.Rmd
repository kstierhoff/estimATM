...
(ref:cal-results-sd) Wideband transceiver (EK80 WBT-Mini, Simrad) beam model results estimated from a dockside calibration with a WC38.1. Calibrated on-axis gain ($G_0$), beam angles and angle offsets, and $S_a$ Correction ($S_\mathrm{a}\mathrm{corr}$) values were applied in Echoview during post-processing.
