...
To minimize acoustic interference, transmit pulses from the ME70, the MS70, the SX90, and the acoustic Doppler current profiler (Ocean Surveyor Model OS75 ADCP, Teledyne RD Instruments) on _`r survey.vessel`_ were triggered using a synchronization system (K-Sync, Simrad). All other instruments that produce sound within the echosounder bandwidths were secured during daytime survey operations. Exceptions were made during stations (e.g., plankton sampling and fish trawling) or in shallow water when the vessel's command occasionally operated the bridge's 50- and 200-kHz echosounders (Furuno), the Doppler velocity log (Model SRD-500A, Sperry Marine), or both. Transmit pulses from the echosounders and sonars aboard _Lisa Marie_ and _Long Beach Carnage_ were not synchronized.  
...
**[Highlight any differences between processing templates for other vessels.]**  
...
Purse seines were set to provide information about size, age, and species composition of fishes observed in the echosounders mounted on the fishing vessels that sampled the nearshore region. All specimens collected by _Lisa Marie_ and _Long Beach Carnage_ were frozen and later processed by the Washington Department of Fish and Wildlife (WDFW) or California Department of Fish and Wildlife (CDFW), respectively. **[Include details on purse seine dimensions, mesh size, etc.?]**  
...
During Leg IV (from 26 August to 6 September), _`r survey.vessel`_ coordinated sampling with F/V _Long Beach Carnage_ in the Southern CA Bight between Pt. Conception and San Diego and around Santa Cruz and Santa Catalina Islands.  
...
Acoustic backscatter ascribed to CPS in the offshore region was generally greatest along the innermost portions of transects conducted between approximately Cape Mendocino and San Francisco, and in the SCB off San Clemente Island and San Diego (**Fig. \@ref(fig:nasc-offshore)**). Jack Mackerel eggs were predominant in the offshore region and often extended to the ends of the 100 nmi-long transect extensions (**Fig. \@ref(fig:nasc-cufes-trawl)b**). Some Pacific Sardine eggs were also present in offshore transects off central CA. Relatively few trawl samples were collected in the offshore region; of those that contained CPS, Jack Mackerel were most abundant, with some Pacific Mackerel and Pacific Sardine also present (**Fig. \@ref(fig:nasc-cufes-trawl)c**).  
...
```{r nasc-trawl-sd, fig.cap='(ref:nasc-trawl-sd)', out.width='7in', fig.pos='H'}
...
+ The USV sampling acoustic transects nearshore, where wind was often light and variable, had difficulty navigating and progressed slowly along the coasts of WA and OR compared to the offshore USVs, and therefore had decreased coincident sampling with _`r survey.vessel`_;
