...
# Create a column with beam model units
bm.units.lbc <- data.frame(Units = c("", "dB re 1","dB re 1","","deg","deg","deg","deg"))
...
bm.units.sd <- data.frame(Units = c("kHz", "", "", "dB re 1 sr", "dB re 1 m$^{2}$", 
                                    "dB re 1","dB re 1","","deg","deg","deg","deg"))
...
Kevin L. Stierhoff, Juan P. Zwolinski, Josiah S. Renfree, Gabriel E. Johnson, Scott A. Mau, David W. Murfin, Thomas S. Sessions, and David A. Demer
...
The collection and analysis of the survey data was conducted by members of the Fisheries Resources Division at the SWFSC. Superscripts denote additional roles and affiliations of cruise participants: 1-Chief Scientist and 2-Volunteer.  
...
* Leg I:   A. Friere, D. Griffith, M. Human, D. Jones^2^, B. Overcash, D. Pinkard-Meier^2^, R. Reed^2^, and L. Vasquez de Mercado
* Leg II:  S. Bal Raj^2^, E. Gardner, H. Hicks^2^, B. Overcash, L. Vasquez de Mercado, W. Watson, and A. Whalen^2^
* Leg III: E. Gardner, N. Hunter^2^, D. Hwang^2^, H. Manjebrayakath^2^, A. Thompson, L. Vasquez de Mercado, and E. Weber^1^
* Leg IV:  M. Craig, A. Friere, D. Griffith, A. Hays, T. Howard^2^, and K. Runge^2^
...
During `r tolower(survey.season)` `r survey.year`, the west coasts of the United States and Vancouver Island, Canada, were surveyed using _`r survey.vessel`_. Compulsory transects were nearly perpendicular to the coast with separations of 10 to 20 nmi. The survey began off `r survey.landmark.n`, and progressed southwards toward `r survey.landmark.s`. Irrespective of the size of the stock and the extent of its migration, the northern stock of Pacific Sardine resides within its potential habitat [@Zwolinski2011].  

The planned transects (**Fig. \@ref(fig:survey-plan)**) spanned the latitudinal extent of the potential habitat of the northern stock of Pacific Sardine^[http://swfscdata.nmfs.noaa.gov/AST/sardineHabitat/habitat.asp] at the time of the survey (**Fig. \@ref(fig:sardine-habitat)**). Transect positions, lengths, and spaces were adjusted during the survey according to the observed distribution of putative CPS backscatter in the echosounders, CPS eggs in CUFES, or CPS caught in trawls. To estimate CPS biomass in offshore waters not routinely sampled during CCE surveys, sampling was also conducted by _`r survey.vessel`_ and two USVs (SD-1045 and SD-1046) along ~100 nmi-long extensions of compulsory transects spaced ~80 nmi-apart between approximately Florence, OR and San Diego. To estimate CPS biomass near shore, where it is too shallow to navigate NOAA ships safely, sampling from _`r survey.vessel`_ was augmented with echosounder and purse-seine sampling with two fishing vessels, and echosounder sampling from a third USV. The coasts of WA and OR were surveyed by F/V _Lisa Marie_; the coasts of WA, OR, and CA (north of Pt. Conception) were surveyed by a USV; and the coasts of the Southern CA Bight (SCB), Santa Cruz and Santa Catalina Islands were surveyed by F/V _Long Beach Carnage_.  
...
```{r ev-filtering-example,fig.cap='(ref:ev-filtering-example)',out.width = '5in',fig.pos='H'}
...
The net, a Nordic 264 rope trawl (NET Systems; Bainbridge Island, WA; **Fig. \@ref(fig:trawl-diagrams)a,b**), has a rectangular opening in the fishing portion of the net with an area of approximately 300 m^2^ (~15-m tall x 20-m wide), variable-sized mesh in the throat, an 8-mm square-mesh cod-end liner (to retain a large range of animal sizes), and a "marine mammal excluder device" to prevent the capture of large animals, such as dolphins, turtles, or sharks [@Dotson2010]. The trawl doors are foam-filled and the trawl headrope is lined with floats so the trawl tows at the surface.  

Up to three nighttime (i.e., 60 min after sunset to 30 min before sunrise) surface trawls, typically spaced 5-10 nmi-apart, were conducted in areas where echoes or eggs from putative CPS schools were observed earlier that day. Each evening, trawl locations were selected by an acoustician who monitored CPS echoes and a member of the trawl group who measured the densities of CPS eggs in CUFES. The locations were provided to the watch officers who charted the proposed trawl sites. Trawl locations were selected using the following criteria, in descending priority: CPS schools in echograms that day, CPS eggs in CUFES that day, and the trawl locations and catches during the previous night. If no CPS echoes or CPS eggs were observed along the transect(s) that day, the trawls were alternatively placed nearshore one night and offshore the next night, with consideration given to the seabed depth and the modeled distribution of Pacific Sardine habitat.  

Trawls were towed at ~4 kn for 45 min. The total catch from each trawl was weighed and sorted by species or groups. From the catches with CPS, up to 50 fish were selected randomly for each of the target species. Those were weighed and measured to either their standard length ($L_S$; mm) for Pacific Sardine and Northern Anchovy, or fork length ($L_F$; mm) for Jack Mackerel, Pacific Mackerel, and Pacific Herring. In addition, sex and maturity were recorded for up to 50 specimens from all species. If active, hydrated, or both, ovaries were preserved for up to 10 specimens of each CPS species except Pacific Herring. Fin clips were removed from all 50 Pacific Sardine and Northern Anchovy specimens and preserved in ethanol for genetic analysis. Otoliths were removed from all 50 Pacific Sardine in the subsample; for other CPS species, 25 otoliths were removed "as equally as possible" from the range of sizes present. Regional species composition was estimated from the nearest trawl cluster, i.e., the combined catches of up to three trawls per night, separated by less than 12 h.  
...
During the day, fish eggs were collected using CUFES [@Checkley1997], which collects water and plankton at a rate of ~640 l min^-1^ from an intake on the hull of the ship at ~3-m depth. The particles in the sampled water were sieved by a 505 $\mu$m mesh. Pacific Sardine, Northern Anchovy, Jack Mackerel, and Pacific Hake (_Merluccius productus_) eggs were identified to species, counted, and logged. Eggs from other species (e.g., Pacific Mackerel and flatfishes) were also counted and logged as "other fish eggs". Typically, the duration of each CUFES sample was 30 min, corresponding to a distance of 5 nmi at a speed of 10 kn. Because the durations of the initial egg stages is short for most CPS, the egg distributions inferred from CUFES indicate the nearby presence of actively spawning fish.  

A CalCOFI bongo oblique net [a bridleless pair of 71-cm diameter nets with 505-$\mu$m mesh; @Smith1977] was used to opportunistically sample ichthyoplankton and krill after sunset. Where there was adequate depth, 300 m of wire was deployed at a rate of 50 m min^-1^ and then retrieved at 20 m min^-1^, at a nominal wire angle of 45$^\circ$. Bongo samples were stored in 5% buffered formalin.  

### Conductivity and temperature versus depth (CTD) sampling {#methods-ctd-sampling}
Day and night, conductivity and temperature were measured versus depth to `r ctd.depth` m using calibrated sensors on a CTD rosette or underway probe (UnderwayCTD, or UCTD; Teledyne Oceanscience) cast from the vessel. These data were used to estimate the time-averaged sound speed [@Demer2004c], for estimating ranges to the sound scatterers, and frequency-specific sound absorption coefficients, for compensating signal attenuation of the sound pulse between the transducer and scatterers [@Simmonds2005]. These data indicated the depth of the surface mixed layer, above which most epipelagic CPS reside during the day, which is later used to determine the integration-stop depth during acoustic data processing.  

\newpage  

# Results {#results}
## EK80 echosounder calibration {#results-echosounder-calibration}
The EK80s were calibrated between `r cal.datetime` while the vessel was alongside the pier near `r cal.loc` (`r cal.lat.dd` $^\circ$N, `r cal.lon.dd` $^\circ$W). Measurements of sea-surface temperature ($t_w$ = `r cal.temp` $^\circ$C) and salinity ($s_w$ = `r cal.sal` psu) were measured to a depth of 10 m using a handheld probe (Pro2030, YSI) and input to the WBT-control software (EK80 `r ek80.version`, Simrad), which derived estimates of sound speed ($c_w$ = `r cal.c` m s^-1^) and absorption coefficients (see **Table \@ref(tab:cal-results)**). Varying with tide, the seabed was approximately `r cal.min.z` to `r cal.max.z` m beneath the transducers. The calibration spheres were positioned nominally 3.5-7 m below the transducers, and adjusted to be in the far-field for each frequency.  

WBT information, configuration settings, and beam model results following calibration are presented in **Table \@ref(tab:cal-results)**. Measurements of uncompensated sphere target strength ($TS_u$, dB re 1 m^2^) are plotted in **Fig. \@ref(fig:tsu-plot)** and beam-compensated sphere target strength relative to the theoretical target strength ($TS_{rel}$, dB re 1 m^2^), are plotted in **Fig. \@ref(fig:tsc-plot)**. During the impedance measurements with the centerboard in the retracted position, and later confirmed during calibration, one quadrant of the 18-kHz transducer appeared to be dysfunctional. An examination of impedance measurements made during the survey with the centerboard in the extended position indicated that the transducer may have been functional during the survey. Therefore, the results of the last known good calibration of the 18-kHz transducer, from the 2018 Summer CCE survey, are presented in **Table \@ref(tab:cal-results)**.  

<!-- A time-series of calibration results for _`r survey.vessel`_, including on-axis gain ($G_0$), $S_a$ correction ($S_\mathrm{a}\mathrm{corr}$), beamwidths ($\alpha_{-3dB}$ and $\beta_{-3dB}$), offset angles ($\alpha_0$ and $\beta_0$), and RMS, are plotted in **Fig. \@ref(fig:cal-ts-plot)**.   -->
...
# Note: settings and calibration results for the 18 kHz GPT are from the last known good calibration conducted prior to the 2018 Summer CCE survey.
...
The survey spanned an area from approximately `r survey.landmark.n`, to `r survey.landmark.s` (**Fig. \@ref(fig:station-sampling)**), with `r nrow(nasc.summ)` east-west transects totaling `r sprintf("%.0f",sum(nasc.summ$distance))` nmi, and `r nrow(trawl.summ)` Nordic trawls.  
...
Nearshore acoustic sampling was conducted along ~5 nmi-long transects spaced ~5 nmi apart to provide estimates of CPS biomass in shallow, nearshore waters where _`r survey.vessel`_ did not sample. During Legs I and IV, _`r survey.vessel`_ sampling off the coasts of WA and OR and in the Southern CA Bight was augmented with nearshore echosounder and purse-seine sampling from industry fishing vessels, F/V _Lisa Marie_ and _Long Beach Carnage_, respectively. Additionally, a USV conducted echosounder sampling nearshore, between Cape Flattery, WA and Pt. Conception. Details of those surveys are presented in **Appendix \@ref(appendix-nearshore)**.  

### Ichthyoplankton and oceanographic sampling {#results-other-sampling}
A total of `r nrow(ctd.sta)` CTD casts and `r nrow(bongo.sta)` bongo tows were conducted throughout the survey. In addition, `r nrow(uctd.sta)` UCTD casts were conducted and `r nrow(cufes.raw)` CUFES samples were collected underway. The locations of CTD and UCTD stations are presented in **Fig. \@ref(fig:station-sampling)** and **Appendix \@ref(appendix-ctd-sampling)**.  
...
Acoustic backscatter ascribed to CPS (**Fig. \@ref(fig:nasc-cufes-trawl)a**) was observed throughout the survey area, but was most prevalent off southwest Vancouver Island and Cape Flattery; between Bodega Bay and Morro Bay; and along the inshore halves of transects conducted in the Southern California Bight.  
...
## Advantages  
+ USVs sampling offshore acoustic transects where wind was ample provided coincident sampling with _`r survey.vessel`_ and greatly increased the collection of acoustic backscatter data throughout much of the survey area;
+ Fishing vessels extended the echosounder and net-catch data to nearshore areas where _`r survey.vessel`_ could not safely navigate or trawl. With coordination, the sampling from _`r survey.vessel`_ was concomitant with sampling from _Lisa Marie_ off WA and OR, and from _Long Beach Carnage_ off SCB.  

## Disadvantages  
+ The USV sampling nearshore acoustic transects where wind was often light and variable had difficulty navigating and progressed slowly along the coasts of WA and OR compared to the offshore USVs, and therefore had decreased coincident sampling with _`r survey.vessel`_;
+ The fishing vessels and USVs sampled with fewer echosounder frequencies than _`r survey.vessel`_. Consequently, there were differences in the acoustic data processing which may affect the identification of CPS echoes.  
...
# Nearshore sampling {#appendix-nearshore}
## Background {#appendix-nearshore-background}  

In summer 2018, _`r survey.vessel`_ only surveyed in water depths greater than ~20 to 30 m, and therefore potentially under-sampled any CPS aggregations in the shallower, nearshore area. In summer 2019, collaborative research was conducted contemporaneously to quantify this potential sampling bias by using two fishing vessels, F/V _Lisa Marie_ and F/V _Long Beach Carnage_, and one USV to extend the sampling closer to shore. The methods and preliminary results from those surveys are presented here.  

## Methods {#appendix-nearshore-methods}

### Survey region and design {#appendix-nearshore-survey-design}  

Nearshore acoustic sampling was conducted during the day along ~5 nmi-long transects spaced ~5 nmi apart placed as close to shore as possible to provide estimates of CPS biomass in shallow, nearshore waters between Cape Flattery and San Diego. Acoustic sampling was conducted from F/V _Lisa Marie_ along the coast of WA and OR; and from and F/V _Long Beach Carnage_ along the mainland coast and around the northern Channel Islands in the Southern CA Bight; purse seines were set from each vessel to provide information about acoustic targets. Acoustic-only sampling was conducted from the nearshore USV between Cape Flattery and Pt. Conception; trawl samples from _`r survey.vessel`_ provided information about acoustic targets.  

### Acoustic sampling {#appendix-nearshore-acoustic-sampling}

#### F/V _Lisa Marie_ {#appendix-nearshore-acoustic-sampling-lisa-marie}

During Leg I (from 20 June to 1 July), _`r survey.vessel`_ coordinated sampling with F/V _Lisa Marie_ between Cape Flattery, WA and the OR-CA border. Aboard _Lisa Marie_, SWFSC’s split-beam echosounder (Simrad EK60 GPT) was connected to the vessel's 38-kHz transducer (Simrad ES38-B), which was calibrated while on anchor in Grays Harbor (46.9236, -124.1181) on 8 May. Transmit pulses from the echosounder and sonar were not synchronized.  

_Lisa Marie_ conducted echosounder-sonar transects between the eastern ends of _`r survey.vessel`_’s acoustic transects and shore. Purse seines were set to provide information about size, age, and species composition of fishes observed in the echosounders (see **Appendix \@ref(appendix-nearshore-net-sampling)** below). All specimens were frozen and later processed by the Washington Department of Fish and Wildlife (WDFW). On 21 June, Greg Shaughnessy (Ocean Gold Seafoods) embarked _`r survey.vessel`_ to observe survey operations. At the same time, Josiah Renfree boarded _Lisa Marie_ to remedy minor issues with the echosounder before rejoining _`r survey.vessel`_. At ~1900 on 25 June, Mr. Shaughnessy disembarked and was put ashore in Westport, WA via _`r survey.vessel`_'s skiff.  

#### F/V _Long Beach Carnage_ {#appendix-nearshore-acoustic-sampling-carnage}  

During Leg IV (from 26 August to 6 September), _`r survey.vessel`_ coordinated sampling with F/V _Long Beach Carnage_ in the Southern CA Bight between Pt. Conception and San Diego and around the northern Channel Islands. Aboard _Long Beach Carnage_, the SWFSC's multi-frequency EK60 GPTs (70, 120, 200, and 333 kHz; Simrad) were configured with the SWFSC's split-beam multi-frequency transducer array (MTA4, ES38-12, ES70-7C, ES120-7C and ES200-7C; Simrad) mounted on the bottom of a pole. The transducers were calibrated on 18 May in the SWFSC's Ocean Technology Development Tank. Transmit pulses from the echosounder and sonar were not synchronized.   

 _Long Beach Carnage_ conducted echosounder-sonar transects between the eastern ends of _`r survey.vessel`_’s acoustic transects and shore. Purse seines were set to provide information about the size, age, and species composition of fishes observed in the echosounders (see **Appendix \@ref(appendix-nearshore-net-sampling)** below). All specimens were frozen and later processed by the California Department of Fish and Wildlife (CDFW).  
 
#### Unmanned surface vehicles {#appendix-nearshore-acoustic-sampling-saildrone}  

During Leg IV (from 20 June to 24 August), one USV (SD-1047) conducted daytime acoustic sampling in shallow, nearshore waters between Cape Flattery and Pt. Conception. Between approximately Tillamook, OR and Pt. Arena, transects were sampled at 10-nmi spacing to allow the USV to catch-up to _`r survey.vessel`_.  

### Purse seine sampling {#appendix-nearshore-net-sampling}
#### F/V _Lisa Marie_ {#appendix-nearshore-net-sampling-lisa-marie}

As many as three purse seine sets was planned each day. For each set, three dip net samples, spatially separated as much as possible, were collected. For each dip net sample, Pacific Sardine, Northern Anchovy, Jack Mackerel, Pacific Mackerel, and Pacific Herring were sorted, weighed, and counted to provide a combined weight and count for each species. Next, all three dip net samples were combined and up to 50 specimens were randomly sampled to provide a combined weight for each set.

The length (mm; $L_S$ for Pacific Sardine and Northern Anchovy and $L_F$ for all others) and weight was measured for up to 25 randomly selected specimens of each species. Otoliths were extracted, macroscopic maturity stage was determined visually, and gonads were collected and preserved from female specimens.  

#### F/V _Long Beach Carnage_ {#appendix-nearshore-net-sampling-carnage}

A maximum of one set per day was planned during daylight hours; in the event of abundant CPS or an unsuccessful daytime set, a set could be made at night. For each set, three dip net samples, spatially separated as much as possible, were collected and specimens frozen for later analysis by CDFW biologists. The total weight (tons) of the entire school was estimated by the captain. After the survey, each dip net sample was sorted, weighed, and counted to provide a combined weight and count for each species. Next, all three dip net samples were combined and up to 50 specimens were randomly sampled to provide a combined weight for each set.  

The length (mm; $L_S$ for Pacific Sardine and Northern Anchovy and $L_F$ for all others) and weight was measured for up to 50 randomly selected specimens of each species. Otoliths were extracted, macroscopic maturity stage was determined visually. Since samples were frozen, no gonad samples were analyzed from female specimens.  

## Results {#appendix-nearshore-results}

### Echosounder calibration {#appendix-nearshore-results-calibration}

#### _Lisa Marie_ {#appendix-nearshore-results-calibration-lisa-marie}  

General purpose transceiver (EK60 GPT, Simrad) beam model results following calibration. Calibration parameters were derived using the following methods: (1) the two excursions processed separately using the EK80 software, (2) both excursions combined and processed using the EK80 software, and (3) both excursions combined and processed using Echoview and Matlab. On-axis gain ($G_0$), beam angles and angle offsets, and $S_a$ Correction ($S_\mathrm{a}\mathrm{corr}$) values from Excursion 2 applied in Echoview during post-processing.  

```{r cal-results-lisa-marie,results='asis'}
if (doc.type == "docx") {
  # create kable object (for Word)
  ...
  kable(all.output.lm, format = knitr.format, 
    ...
    # row_spec(18, hline_after = T) %>% 
    add_header_above(c(" " = 2, "Method" = ncol(all.output.lm) - 2))
}
```  

#### _Long Beach Carnage_ {#appendix-nearshore-results-calibration-carnage}  

General purpose transceiver (EK60 GPT, Simrad) beam model results following calibration. Prior to the survey, on-axis gain ($G_0$), beam angles and angle offsets, and $S_a$ Correction ($S_\mathrm{a}\mathrm{corr}$) values from calibration results were entered into the GPT-control software (EK80, Simrad).  

```{r cal-results-carnage,results='asis'}
if (doc.type == "docx") {
  # create kable object (for Word)
...
#### Unmanned surface vehicle {#appendix-nearshore-results-calibration-saildrone} 

Wideband transceiver (EK80 WBT-Mini, Simrad) beam model results following calibration. On-axis gain ($G_0$), beam angles and angle offsets, and $S_a$ Correction ($S_\mathrm{a}\mathrm{corr}$) values from calibration results were applied in Echoview during post-processing.  
...
if (doc.type == "docx") {
  ...
  kable(all.output.sd, format = knitr.format, 
    ...
    add_header_above(c(" " = 2, "Saidrone" = 6))
}
```  

### Acoustic and purse seine sampling {#appendix-nearshore-results-sampling}

```{r load-nearshore-nasc-summary}
load(here("Output/purse_seine_sets.Rdata"))
load(here("Output/nasc_summ_tx_ns.Rdata"))

nasc.summ.lm  <- filter(nasc.summ.ns, vessel.name == "LM")
nasc.summ.lbc <- filter(nasc.summ.ns, vessel.name == "LBC")
nasc.summ.sd  <- filter(nasc.summ.ns, vessel.name == "SD")
```

F/V _Lisa Marie_ surveyed the nearshore area from approximately Cape Flattery the WA-OR border (**Fig. \@ref(fig:nasc-seine-lm)**), with `r nrow(nasc.summ.lm)` east-west transects totaling `r sprintf("%.0f",sum(nasc.summ.lm$distance))` nmi and `r nrow(lm.sets)` purse seine sets. F/V _Long Beach Carnage_ surveyed the nearshore area from approximately Pt. Conception to San Diego, including the nearshore areas around Santa Cruz and Santa Catalina Islands  (**Fig. \@ref(fig:nasc-seine-lbc)**), with `r nrow(nasc.summ.lbc)` east-west transects totaling `r sprintf("%.0f",sum(nasc.summ.lbc$distance))` nmi and `r nrow(lbc.sets)` purse seine sets. The USV (SD-1045) surveyed the nearshore area between Cape Flattery and Pt. Conception, with `r nrow(nasc.summ.sd)` east-west transects totaling `r sprintf("%.0f", sum(nasc.summ.sd$distance))` nmi.  

### Distribution of CPS {#appendix-nearshore-results-distribution}

Acoustic backscatter sampled by F/V _Lisa Marie_ and ascribed to CPS off the WA and OR coast was most prevalent near the Columbia River and around Newport (**Fig. \@ref(fig:nasc-seine-lm)a**). Acoustic backscatter sampled by F/V _Long Beach Carnage_ and ascribed to CPS was observed throughout the nearshore survey area in the SCB, but was most prevalent between Santa Barbara and Malibu; and between Costa Mesa and La Jolla (**Fig. \@ref(fig:nasc-seine-lbc)a**). Acoustic backscatter sampled by the nearshore USV and ascribed to CPS off the coasts of WA, OR, and CA was most prevalent near the Columbia River; off San Francisco Bay; and between Carmel, CA and Morro Bay (**Fig. \@ref(fig:nasc-trawl-sd)a**).

Pacific Herring catches were predominant, by weight, in purse seine and trawl samples collected between Cape Flattery and Newport (**Fig. \@ref(fig:nasc-seine-lm)b**, **Fig. \@ref(fig:nasc-trawl-sd)b**). Jack Mackerel dominated the purse seine catches between approximately Newport and the OR-CA border (**Fig. \@ref(fig:nasc-seine-lm)b**), and trawl samples between approximately Newport and Bodega Bay (**Fig. \@ref(fig:nasc-trawl-sd)b**). Northern Anchovy were present in four purse seines set by _Lisa Marie_ and one set by _Long Beach Carnage_ (most catches not visible at this scale), but were most abundant north of the Columbia River (**Fig. \@ref(fig:nasc-seine-lm)b**). In trawl samples, Northern Anchovy were predominant species caught between Bodega Bay and San Diego (**Fig. \@ref(fig:nasc-trawl-sd)b**). Pacific Sardine were caught in relatively small numbers in purse seine samples between the Columbia River and Newport (**Fig. \@ref(fig:nasc-seine-lm)b**), but dominated the purse seine samples collected throughout the SCB (**Fig. \@ref(fig:nasc-seine-lbc)b**). Pacific Sardine were caught in relatively small numbers in trawl samples between the Columbia River and Cape Mendocino (**Fig. \@ref(fig:nasc-trawl-sd)b**). A few Pacific Mackerel were caught purse seine samples collected in the SCB near Anacapa Island and Long Beach (**Fig. \@ref(fig:nasc-seine-lbc)b**), and in trawl samples collected along the OR and northern CA coasts (**Fig. \@ref(fig:nasc-trawl-sd)b**).  

## Discussion {#appendix-nearshore-discussion}

+ Both industry vessels closely adhered to the planned transect lines and, with coordination, sampled coincident with _`r survey.vessel`_ in their respective survey areas.
+ Species composition of purse seine samples collected by _Lisa Marie_ were similar to catch from _Lasker_ off the coast of WA and OR. 
+ Species composition of purse seine samples collected by _Long Beach Carnage_ were dominated by Pacific Sardine, whereas Northern Anchovy dominated trawls conducted by _Lasker_ in the same areas.

\newpage

(ref:nasc-seine-lm) Nearshore survey transects conducted by F/V _Lisa Marie_ overlaid with a) the distribution of 38-kHz integrated backscattering coefficients ($s_A$, m^2^ nmi^-2^; averaged over 2000-m distance intervals and from `r int.start`- to `r cps.depth`-m deep) ascribed to CPS and b) the proportions, by weight, of CPS species in each purse seine set (black points indicate sets with no CPS).
...
(ref:nasc-seine-lbc) Nearshore survey transects conducted by F/V _Long Beach Carnage_ overlaid with a) the distribution of 38-kHz integrated backscattering coefficients ($s_A$, m^2^ nmi^-2^; averaged over 2000-m distance intervals and from `r int.start`- to `r cps.depth`-m deep) ascribed to CPS and b) the proportions, by weight, of CPS species in each purse seine set (black points indicate sets with no CPS).
...
(ref:nasc-trawl-sd) Nearshore survey transects conducted by an unmanned surface vehicle (USV; SD-1045) overlaid with a) the distribution of 38-kHz integrated backscattering coefficients ($s_A$, m^2^ nmi^-2^; averaged over 2000-m distance intervals and from `r int.start`- to `r cps.depth`-m deep) ascribed to CPS and b) the proportions, by weight, of CPS species in the nearest trawl samples collected by _`r survey.vessel`_ (black points indicate sets with no CPS).

```{r nasc-trawl-sd, fig.cap='(ref:nasc-trawl-sd)', out.height='8in', fig.pos='H'}
