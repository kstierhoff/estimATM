...
**Report on the `r survey.name.long` (`r survey.name`), `r survey.start` to `r survey.end` `r survey.year`, conducted aboard NOAA Ship _`r survey.vessel.long`_ and the fishing vessels _Long Beach Carnage_**  

Juan P. Zwolinski^1,3^, Noelle M. Bowlin^1^, David A. Demer^1^, Brad E. Erisman^1^, Gabriel E. Johnson^1,2^, Scott A. Mau^1^, David W. Murfin^1^, Josiah S. Renfree^1^, Brittany D. Schwartzkopf^1^, Thomas S. Sessions^1^, Kevin L. Stierhoff^1^, Lanora Vasquez^1^, and William Watson^1^ **[add authors as appropriate]**
...
The collection of the survey data were conducted by members of the Fisheries Resources Division at the SWFSC, and scientists and staff of California Department of Fish and Wildlife (CDFW) and the California Wetfish Producers Association (CWPA).  

**Project Lead:**

* _Reuben Lasker_: J. Zwolinski
...
Asterisks denote Chief Scientists  
...
The survey area is initially defined with consideration to the expected distribution of a priority stock or stock assemblage, in this case, the central stock of Northern Anchovy (**Fig. \@ref(fig:anchovy-distribution)**). The survey area is further expanded to encompass as much of the potential habitat as possible for other CPS present off the West Coast of the U.S., as time permits.  

During `r tolower(survey.season)` `r survey.year`, a portion of the west coast of the United States was surveyed using _`r survey.vessel`_ and _Long Beach Carnage_. Compulsory transects were nearly perpendicular to the coast with separations of 15 nmi south of Pt. Conception, and 20 nmi north of Pt. Conception. The survey began off `r survey.landmark.s`, and progressed northwards toward `r survey.landmark.n`.  

The planned transects (**Fig. \@ref(fig:survey-plan)**) spanned the latitudinal extent of the expected distribution of the central stock of Northern Anchovy (**Fig. \@ref(fig:anchovy-distribution)**). The offshore extent of planned transects was adjusted during the survey according to the observed distribution of putative CPS backscatter in the echosounders, CPS eggs in CUFES samples, or CPS caught in trawls. To estimate CPS biomass near shore, where it is too shallow to navigate NOAA ships safely, sampling from _`r survey.vessel`_ was augmented with echosounder and purse-seine sampling from F/V _Long Beach Carnage_ south of Pt. Conception and around Santa Cruz and Santa Catalina Islands (**Fig. \@ref(fig:survey-plan)**).  

(ref:anchovy-distribution) Distribution of Northern Anchovy eggs sampled by the CUFES during spring surveys from 2017 through 2019. Eggs indicate the presence of spawning Northern Anchovy and were used to delineate the spring 2021 survey area.
...
For every set, three (3) dip net samples were collected from the purse seine net. Each dip net sample was put in a bag and tagged with a date, time of capture, latitude and longitude, transect line number, school and dip net numbers, and estimated tonnage of entire school. Ashore, CDFW biologists processed the samples according to the following protocol:  

+ For each dip net sample, Pacific Sardine, Northern Anchovy, Pacific Mackerel, and Jack Mackerel were sorted and the number of fish and combined weight of each species were recorder.
...
Otoliths were extracted from all random specimens. The catch and biological data were shared with SWFSC for analysis.  
