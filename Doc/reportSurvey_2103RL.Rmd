...
process.cal     <- T # process calibration results from previous surveys for time series plots
...
```{r sardine-habitat,fig.cap='(ref:sardine-habitat)',out.width = '7in',fig.align='center',fig.pos='H',eval=FALSE}
