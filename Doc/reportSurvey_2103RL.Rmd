...
all.output <- all.output %>%
  filter(!` ` %in% c("Angle Sensitivity Along. ($\\mathrm{\\Lambda}_{\\alpha}$)",
                     "Angle Sensitivity Athw. ($\\mathrm{\\Lambda}_{\\beta}$)",
                     "Bandwidth ($W_\\mathrm{f}$)", 
                     "Absorption Coefficient ($\\alpha_\\mathrm{f}$)",
                     "Angle Offset Along. ($\\alpha_{0}$)",
                     "Angle Offset Athw. ($\\beta_{0}$)",
                     "Ambient Noise"))
...
On 20 March, _`r survey.vessel`_ departed from 10th Avenue Marine Terminal in San Diego at ~1400 (all times UTC). Acoustic sampling commenced from south to north along transect 002 (**Fig. \@ref(fig:station-sampling)**, **Appendix \@ref(appendix-core-transects)**). On 1 April, acoustic sampling ceased after the middle portion of transect 010 off Point Mugu, CA, when _`r survey.vessel`_ transited to Dana Point, CA to exchange scientific personnel before completing Leg I.  

**Leg II**  

On 1 April, _`r survey.vessel`_ resumed sampling along transect 012 (**Fig. \@ref(fig:station-sampling)**, **Appendix \@ref(appendix-core-transects)**) near Santa Barbara, CA. On 12 April, acoustic sampling ceased after the completion of transect 028 off Bodega Bay, CA. At ~1700 on 16 April, _`r survey.vessel`_ arrived at Pier 30/32 in San Francisco Bay to complete Leg II.  
