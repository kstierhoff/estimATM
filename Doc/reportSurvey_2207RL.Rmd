...
nasc.map.ns.lbc <- base.map +
  ...
  coord_sf(crs = crs.proj, # CA Albers Equal Area Projection
           ...
           ylim = c(map.bounds.ns["ymin"], map.bounds.ns["ymax"]*1.4))
...
[**UPDATE**]
Acoustic backscatter sampled by _Long Beach Carnage_ was observed throughout the entire nearshore survey area off California between Bodega Bay and San Diego, CA San Francisco, San Simeon to Point Conception, Santa Barbara to Ventura, and around Santa Cruz Island (**Fig. \@ref(fig:nasc-seine-lbc)a**).  
