...
copy.files      <- F # copy trawl, CUFES, and NASC files from source
copy.bib        <- F # copy files from source; requires VPN (LEAVE AS F)
overwrite.csv   <- T # overwrite CSV files when copying
overwrite.files <- T # overwrite files (non CSV) when copying
...
* Leg I:   J. Renfree^1^, D. Palance^1^, and M. Santiago
* Leg II:  D. Palance, S. Dolan, and S. Mau^1^
* Leg III: J. Zwolinski^1\*^ and S. Sessions^1^
* Leg IV:  K. Stierhoff^1\*^, A. Beittel^1^, and M. Vasquez-Ortiz^2^

**Trawl Sampling:**

* Leg I:   O. Snodgrass^1^, A. Freire de Carvalho^1^, M. Human^1^, P. Kuriyama^1^, and O. Boisen
* Leg II:  K. James^1^, E. Weber^1^, K. Walsh, and R. Backman
* Leg III: J. Walker^1^, B. Erisman^1^, N. Concha-Saiz^1^, T. Batchel^1^, and L. Havana
* Leg IV:  B. Schwartzkopf^1^, N. Concha-Saiz^1^, T. Batchel^1^, D. Lowry^1^, and D. Hernandez Cruz

**CUFES Sampling:**

* Leg I:   N. Bowling^1\*^ L. Vasquez^1^
* Leg II:  A. Thompson^1^, E. Gardner^1^, and W. Watson^1\*^
* Leg III: A. Hays^1^
* Leg IV:  TBD and S. Morales Gutierrez
