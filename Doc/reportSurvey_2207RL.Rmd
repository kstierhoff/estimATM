...
The forage fish assemblage was dominated by Northern Anchovy south of Bodega Bay, CA. To the north, trawl catches from _`r survey.vessel`_ were predominantly Jack Mackerel, while seine catches from _Lisa Marie_ were predominantly Pacific Sardine between the WA/OR border to Fort Bragg, CA. Based on the differences in _`r survey.vessel`_ and _Lisa Marie_ catches in the overlapping region, in addition to comparative historical results [@Renfree2022] and personal communications with the _Lisa Marie_ captain, it is hypothesized that purse seines are ineffective in catching Jack Mackerel. Therefore, species proportions derived from purse seine data in regions with high Jack Mackerel abundance should be analyzed with caution. 
