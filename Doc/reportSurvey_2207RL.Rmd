...
ctd.sta  <- filter(events_sf, Button == ctd.button, !is.na(Notes)) 
...
Times and locations of conductivity and temperature versus depth casts while on station (CTD) and underway (UCTD). Included are CTD casts conducted by _Shimada_ during the NWFSC's 2022 Integrated Ecosystem and Pacific Hake Acoustic-Trawl Survey, used for processing acoustic data from _Lisa Marie_ and the USVs.
