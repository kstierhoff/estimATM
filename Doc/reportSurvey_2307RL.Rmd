...
Historically in spring, the hypothesized northern stock of Pacific Sardine [@Smith2005] aggregates offshore of central and southern California to spawn [@nieto2014effect]. During summer, adults migrate north, compress along the coast, and feed in the upwelled regions (**Fig. \@ref(fig:sardine-distribution)**). However, since the population began to decline in 2012, spawning off central and southern California has rapidly diminished [see Figure 2 in @Zwolinski2023c], suggesting that a significant portion of the stock observed in the summer months north of Cape Mendocino is no longer migrating south in the winter and spring [@Zwolinski2023b; @Stierhoff2023a].  
