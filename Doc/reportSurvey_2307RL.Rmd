...
**Report on the `r survey.name.long` (`r survey.name`), `r survey.start` to `r survey.end` `r survey.year`, conducted aboard NOAA ships _`r survey.vessel.long`_ and _Bell M. Shimada_, fishing vessels _Lisa Marie_ and _Long Beach Carnage_, and uncrewed surface vehicles**  

Josiah S. Renfree^1^, Alice Beittel^2^, Noelle M. Bowlin^1^, Brad E. Erisman^1^, Scott A. Mau^1^, David W. Murfin^1^, Brittany D. Schwartzkopf^1^, Thomas S. Sessions^1^, Kevin L. Stierhoff^1^, Lanora Vasquez^1^, William Watson^1^, Juan P. Zwolinski^1,3^, and David A. Demer^1^
...
The objectives for the survey were to: 
  ...
  4. Use fishing vessels and USVs to sample transects and nearshore areas (typically within 5 nmi of the coast) when and where sampling from NOAA ships was deemed inefficient, unsafe, or both (**Fig.** \@ref(fig:vessel-pic));
  5. Compare the species and size distributions of CPS and Pacific Hake *Merluccius productus* between night-time _Lisa Marie_ purse seine sets to proximate trawl sampling from *`r survey.vessel.long`*, NOAA FSV _Shimada_, and Canadian R/V _Franklin_; and
  6. Compare the species and size distributions of proximate day-time and night-time _Lisa Marie_ purse seine sets.
  
The survey domain, from *survey.landmark.n* to *survey.landmark.s*, was defined primarily by the historically observed distribution of the northern subpopulation (stock) of Pacific Sardine [@Zwolinski2011], with a southern extension permitted by available sampling effort. This area was chosen to encompass the anticipated distributions of the northern stock of Pacific Sardine and the central and northern stocks of Northern Anchovy off the west coasts of the U.S., Canada, and Mexico, but it also spanned portions of the southern stock of Pacific Sardine, Pacific Mackerel, Jack Mackerel, Pacific Round Herring, and Pacific Herring.
...
The collection and analysis of the survey data were conducted by members of 1-NOAA, 2-UCSC/CIMEAS, 3-OAI, 4-INFISH intern, 5-UCSD/SIO, 6-volunteer, 7-INAPESCA, 8-WDFW, and 9-CWPA. Asterisks denote Chief Scientists.

The survey on _`r survey.vessel`_ was originally divided into three legs, with each leg consisting of two parts (denoted 1 or 2) and a personnel transfer conducted partway through the leg. Leg I.1 and all of Leg II were cancelled due to OMAO staffing shortages and maintenance issues. Because of these issues, a fourth leg, consisting of two parts, was added and conducted by _Shimada_.
...
* Leg III.1:  D. Murfin^1^ and A. Beittel^1^
* Leg III.2:  K. Stierhoff^1\*^
* Leg IV.1:   S. Sessions^1\*^ and A. Beittel^1^
* Leg IV.2:   J. Zwolinski^2\*^ and S. Mau^1^

**Trawl Sampling:**

* Leg I.2:    K. James^1\*^, D. Kuyper^3^, S. Mitchell^4^, B. Bellerud^1^, and N. Concha-Saiz^1^
* Leg III.1:  O. Snodgrass^1\*^, D. Kuyper^3^, G. Angle^1^, and S. Callahan^5^
* Leg III.2:  O. Snodgrass^1^, D. Kuyper^3^, G. Longo^6^, M. Macaskill^5^, and J. Evanilla^6^
* Leg IV.1:   D. Kuyper^3^, N. Concha-Saiz^1^, Z. Skelton^3^, O. Boisen^6^, and B. Lind^1^
* Leg IV.2:   K. James^1^, E. Ruhl^1^, Z. Skelton^3^, and M. Dunlap^1^

**CUFES Sampling:**

* Leg I.2:    L. Vasquez^1^ and S. Morales^7^
...
During `r tolower(survey.season)` `r survey.year`, the west coasts of the United States and Baja California, Mexico were to be surveyed using _`r survey.vessel`_, _Lisa Marie_, _Long Beach Carnage_, and USVs. Compulsory transects were nearly perpendicular to the coast and separated by 10 nmi. The survey was to begin off `r survey.landmark.s` and progress northwards toward `r survey.landmark.n`.    

The planned transects (**Fig. \@ref(fig:survey-plan)**) spanned the latitudinal extent, based on historical observations, of the anticipated distributions of the northern stock of Pacific Sardine and the central and northern stocks of Northern Anchovy. For _`r survey.vessel`_, the planned transects ranged from `r survey.landmark.s` to `r survey.landmark.n`, spaced 20 nmi apart south of Cape Mendocino, CA, 10 nmi between Cape Mendocino, CA to Cape Flattery, WA, and 20 nmi north of Cape Flattery, WA. Off Vancouver Island, BC, adaptive transects would be added 10 nmi north and south of compulsory transects containing observations of CPS.  To further increase the spatial sampling resolution from _`r survey.vessel`_, USVs were to conduct acoustic sampling interstitial to _`r survey.vessel`_ transects between Point Conception, CA and Cape Mendocino, CA. The USVs were to also sample transects spaced 20 nmi apart north of Cape Mendocino, CA, resulting in _`r survey.vessel`_ and the USVs duplicating every other transect. Lastly, in Baja California the Mexican research vessel _Dr. Jorge Carranza Fraser_ was to sample interstitial to _`r survey.vessel`_ transects, although their results are not presented here. The final result would be acoustically-sampled transects spaced 10 nmi apart throughout the entire survey region, except in the Southern California Bight where only _`r survey.vessel`_ would sample with 20-nmi spacing. 

To estimate CPS biomass near shore, typically within 5 nmi of the coast where it is too shallow to navigate NOAA ships safely, sampling from _`r survey.vessel`_ was to be augmented with echosounder and purse-seine sampling from _Lisa Marie_ between Bodega Bay, CA to `r survey.landmark.n`; and from _Long Beach Carnage_ between San Diego, CA to Bodega Bay, CA, and around Santa Cruz and Santa Catalina Islands (**Fig. \@ref(fig:survey-plan)**). And to compare the species and size compositions between the various platforms and net systems, _Lisa Marie_ was to conduct nighttime purse seine sets in proximity to _`r survey.vessel`_ nighttime surface trawls and _Shimada_ daytime midwater trawls between Point Conception, CA to Cape Flattery, WA. _Lisa Marie_ would also conduct daytime purse seine sets throughout the nearshore survey to compare with their nighttime catches.

Due to OMAO staffing shortages and maintenance issues on _`r survey.vessel`_, Leg I.1 and all of Leg II were cancelled, prompting modifications to the sampling plan throughout the survey. All transects off Baja California were abandoned, with Leg I.2 beginning the survey off San Diego, CA. Because of the delay, _`r survey.vessel`_ was unable to conduct comparative trawls with _Shimada_ and _Lisa Marie_.  Moreover, because _Lisa Marie_ delayed its schedule to synchronize its nearshore sampling with _`r survey.vessel`_, comparative purse seine catches with _Shimada_ were only conducted between Point Conception, CA and Bodega Bay, CA. _`r survey.vessel`_ completed its survey, after Leg III, having only sampled to Cape Mendocino, CA. An additional Leg IV on _Shimada_ was then added to sample transects from Cape Mendocino, CA to Cape Flattery, WA [**UPDATE IF NECESSARY**]. No changes were made to the sampling plan for _Long Beach Carnage_ or the USVs.
...
On _Lisa Marie_, multi-frequency Wideband Transceivers (38-, 70-, 120-, and 200-kHz Simrad-Kongsberg EK80 WBTs) were connected to the vessel's hull-mounted split-beam transducers (Simrad-Kongsberg ES38-7, ES70-7C, ES120-7C, and ES200-7C).
...
On the three USVs (SD-1048, SD-1060, and SD-1096), miniature Wideband Transceivers (Simrad-Kongsberg WBT Mini) were configured with gimbaled, keel-mounted, dual-frequency transducers (Simrad-Kongsberg ES38-18|200-18C) containing a split-beam 38-kHz transducer and single-beam 200-kHz transducer with nominally 18$^\circ$ beamwidths.
...
When necessary, the start and stop integration lines were manually edited to exclude reverberation due to bubbles, to include the entirety of shallow CPS aggregations, or to exclude seabed echoes.  Echoes suspected to be from rockfish or hake schools were further excluded.
...
To process acoustic data from the USVs, conductivity and temperature profiles were obtained from CTD casts conducted by _Lisa Marie_ or _Shimada_. For the latter, the casts were acquired during the Northwest Fisheries Science Center's (NWFSC) 2023 Integrated Ecosystem and Pacific Hake Acoustic-Trawl Survey, conducted from 18 June to 15 September, 2023.
...
For _Shimada_, the EK80s were calibrated by the NWFSC on 9 September, 2023 in Seattle, WA after completing the Integrated Ecosystem and Pacific Hake Acoustic-Trawl Survey. Calibration results for _Shimada_ are presented in **Table \@ref(tab:cal-results-sh)**.
...
For _Lisa Marie_, the EK80 WBTs were calibrated on 12 June, 2023 using the standard sphere technique with a WC38.1 while the vessel was anchored in Gig Harbor, WA (47.32212 N, 122.57275 W). Calibration results for _Lisa Marie_ are presented in **Table \@ref(tab:cal-results-lm)**.  
...
For _Long Beach Carnage_, the echosounders were calibrated using the standard sphere technique with a WC38.1 on 18 April, 2023 in a tank at the SWFSC. Calibration results for _Long Beach Carnage_ are presented in **Table \@ref(tab:cal-results-lbc)**.  
...
[**UPDATE AFTER LEG 4**]
Due to the cancellation of Leg I.1 and all of Leg II on _`r survey.vessel`_, transects off Baja California, MX and Vancounver Island, BC were abandoned. Therefore, the core survey region spanned an area from approximately San Diego, CA to Cape Flattery, WA (**Figs. \@ref(fig:transects-and-habitat) and \@ref(fig:nasc-cufes-trawl)**), predominantly including the potential habitat for the northern stock of Pacific Sardine at the time of the survey^[https://coastwatch.pfeg.noaa.gov/erddap/griddap/sardine_habitat_modis.html]. _`r survey.vessel`_ sampled from San Diego, CA to Cape Mendocino, CA, then _Shimada_ sampled from Cape Mendocino, CA to Cape Flattery, WA. The three USVs surveyed interstitial to _`r survey.vessel`_ transects from Grays Harbor, WA to Cape Mendocino, CA [**CHECK THIS**]. In total, _`r survey.vessel`_, _Shimada_, and the three USVs sampled `r n_distinct(nasc.summ$transect.name)` east-west transects totaling `r prettyNum(sum(nasc.summ$distance), digits = 1, big.mark = ",")` nmi, and conducted `r nrow(haul.pie)` Nordic trawls.

The nearshore region was surveyed by _Long Beach Carnage_ and _Lisa Marie_, spanning an area from San Diego, CA to Cape Flattery, WA, including around Santa Cruz and Santa Catalina Islands. The vessels completed `r nrow(nasc.summ.ns.LM) + nrow(nasc.summ.ns.LBC)` east-west transects totaling `r sprintf("%.0f",sum(nasc.summ.ns.LM$distance)+sum(nasc.summ.ns.LBC$distance))` nmi and `r nrow(seine.summ)` purse seine sets (**Figs. \@ref(fig:transects-and-habitat) and \@ref(fig:nasc-seine-lbc)**).
...
[**UPDATE AFTER SAILDRONE DATA IS PROCESSED**]
The three USVs (SD-1048, SD-1060, and SD-1096) sampled transects 052 to 070, from Point Conception, CA to Half Moon Bay, CA, from 21 to 30 July.
...
[**UPDATE AFTER SAILDRONE DATA IS PROCESSED**]
The three USVs sampled transects 102 to 134, from Crescent City, CA to Half Moon Bay, CA to Santiago, WA, from 5 to 29 September. This marked the end of the 2023 survey for the USVs.
...
(ref:transects-and-habitat) Summary of all transects sampled throughout the survey by _`r survey.vessel`_ (red), _Shimada_ (xxx[**UPDATE**]), _Lisa Marie_ (yellow), USVs (blue), and _Long Beach Carnage_ (green), in relation to the potential habitat for the northern stock of Pacific Sardine. The habitat is temporally aggregated using an average of the habitat centered ±2° around each vessel during the survey. Areas in white correspond to no available data, e.g., cloud coverage preventing satellite-sensed observations.

```{r transects-and-habitat,fig.cap='(ref:transects-and-habitat)',out.height = '8in',fig.align='center',fig.pos='H'}
include_graphics(here("Figs/fig_summer2023_habitat_RL_SH.png"))
```  

### Ichthyoplankton and oceanographic sampling {#results-other-sampling}  

On _Lasker_ a total of `r sum(str_detect(uctd.sta$cast, "2307RL"))` UCTD casts (**Appendix \@ref(appendix-ctd-sampling)**), `r sum(str_detect(uctd.sta$cast, "2307RL"))` bongo tows, and `r prettyNum(nrow(cufes.all), digits = 1, big.mark = ",")` CUFES samples were obtained (**Fig. \@ref(fig:station-sampling)**). During Leg IV on _Shimada_, a total of `r sum(str_detect(uctd.sta$cast, "2310SH"))` UCTD casts were conducted; bongo tows and CUFES sampling were omitted due to personnel shortages.

On _Lisa Marie_ and _Long Beach Carnage_, a total of 74 and 13 UCTD casts were conducted, respectively. [**MIGHT WANT TO INCLUDE LM AND LBC CTD PROCESSING**]

A total of 195 CTD casts were obtained from the NWFSC's 2023 Integrated Ecosystem and Pacific Hake Acoustic-Trawl Survey aboard _Shimada_, which were utilized for processing the USV transects. [**INCLUDE IN APPENDIX? IF SO NEED TO INCLUDE IN CTD PROCESSING**]

[**UPDATE DESCRIPTION DEPENDING ON IF SHIMADA HAKE CASTS WERE USED**]
(ref:station-sampling) The locations of surface trawls (white points), CTD and UCTD casts (red circles), and bongo nets (orange triangles) relative to the planned east-west acoustic transects (solid and dashed grey lines) and cruise tracks (thick black line) of _`r survey.vessel`_ and _Shimada_.
...
[**update after all data is processed**]

Acoustic backscatter ascribed to CPS in the core region (**Fig. \@ref(fig:nasc-cufes-trawl)a**), as sampled by _`r survey.vessel`_, _Shimada_, and the USVs, was observed throughout the survey area, but was most prevalent off Cape Flattery, WA and between Fort Bragg to Monterey Bay, CA. 

Surface trawls, conducted by _`r survey.vessel`_ to the south of Cape Mendocinco, CA and to the north by _Shimada_, caught Pacific Sardine primarily in the region off OR and WA, as well as in the SCB; Northern Anchovy south of Cape Mendocino, CA; Jack Mackerel throughout the survey area, but predominantly in the SCB and outside the mouth of the Columbia River; and Pacific Herring off OR and WA. The combined catches of the `r nrow(trawl.summ)` trawls included `r prettyNum(haul.CPS.kg, digits = 1, big.mark = ",")` kg of CPS (`r prettyNum(haul.Sardine.kg, digits = 1, big.mark = ",")` kg Pacific Sardine, `r prettyNum(haul.Anchovy.kg, digits = 1, big.mark = ",")` kg Northern Anchovy, `r prettyNum(haul.JackMack.kg, digits = 1, big.mark = ",")` kg Jack Mackerel, `r prettyNum(haul.PacMack.kg, digits = 1, big.mark = ",")` kg Pacific Mackerel, `r prettyNum(haul.PacHerring.kg, digits = 1, big.mark = ",")` kg Pacific Herring, and `r prettyNum(haul.RndHerring.kg, digits = 1, big.mark = ",")` kg Round Herring; **Appendix \@ref(appendix-trawl-sampling)**).
...
[**UPDATE TO INCLUDE LISA MARIE INFO**]
...
```{r nasc-seine-combined, fig.cap='(ref:nasc-seine-combined)', out.width='6in', fig.pos='H'}
...
<!-- ```{r nasc-seine-lm, fig.cap='(ref:nasc-seine-lm)', out.width='6in', fig.pos='H'} -->
