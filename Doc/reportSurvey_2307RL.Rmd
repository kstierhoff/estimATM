...
```{r nasc-seine-combined, fig.cap='(ref:nasc-seine-combined)', out.height='5.0in', fig.pos='H'}
...
Due to the delays and cancellations on _Lasker_, no core-region trawl sampling was conducted between Cape Mendocino, CA and Reedsport, OR (**Fig. \@ref(fig:nasc-cufes-trawl)a**); and sampling off Baja California, MX was only conducted by _Carranza_, which is presented in a separate report by INAPESCA. Meanwhile, the nearshore sampling by _Lisa Marie_ and _Long Beach Carnage_ was comprehensive of the US west coast. Combined, the trawl and seine sampling indicate that the forage fish assemblage was dominated by Northern Anchovy south of Cape Mendocino, CA. To a smaller extent, Pacific Herring were prevalent north of Cape Mendocino, CA; Pacific Sardine north of Reedsport, OR, and in the nearshore regions off central CA and in the SCB, including around the Santa Catalina and Santa Cruz Islands; Jack Mackerel throughout the survey area, and particularly offshore in the SCB; and Pacific Mackerel nearshore in the SCB and off Florence, OR. From the CUFES samples collected by _Lasker_ south of Cape Mendocino, CA, CPS spawning was dominated by Northern Anchovy throughout the region, with areas of spawning Jack Mackerel near Point Conception, CA and Pacific Sardine near the Santa Cruz and Santa Catalina Islands in the SCB.
