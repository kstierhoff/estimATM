...
For _Lisa Marie_, the EK80 WBTs were calibrated on 12 June, 2023 using the standard sphere technique with a WC38.1 while the vessel was anchored in Gig Harbor, WA (47.32212 $^\circ$N, 122.57275 $^\circ$W). Calibration results for _Lisa Marie_ are presented in **Table \@ref(tab:cal-results-lm)**.  
...
>On 17 July, after a 14-d delay, _Lasker_ departed from the 10th Avenue Marine Terminal in San Diego, CA at ~2000 (all times GMT). Prior to the transit, a calibration for the Simrad EC150-3C ADCP was conducted northwest of the sea buoy outside San Diego Bay (32.6598 $^\circ$N,  117.3833 $^\circ$W). Due to the departure delays, sampling off Baja California was abandoned, with the survey commencing on 18 July along transect 033 off Imperial Beach, CA. On the evening of 22 July, a scientist and member of the deck crew were embarked using _Lasker_’s small boat at Dana Point Harbor. On 29 July, _Lasker_ ceased acoustic sampling after completing the nearshore portion of transect 057 off Morro Bay, CA. At ~1300 on 30 July, _Lasker_ arrived at Pier 30/32 in San Francisco, CA to complete Leg I.
...
>The entirety of Leg II on _Lasker_ was canceled due to staffing shortages and COVID-19 aboard _Lasker_.
