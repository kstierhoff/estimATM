...
get.nav         <- T # download nav data from ERDDAP (if F will load from RData file)
get.nav.sh      <- T # download nav data from ERDDAP (if F will load from RData file)
...
The collection and analysis of the survey data were conducted by members of 1-NOAA, 2-UCSC/CIMEAS, 3-OAI contractor, 4-INFISH intern, 5-UCSD/SIO, 5-INAPESCA, 6-WDFW, 7-CWPA, 8-LBC crew, and 9-volunteers. Asterisks denote Chief Scientists.
...
* Leg III.2:  O. Snodgrass^1^, D. Kuyper^3^, G. Longo, M. Macaskill, and J. Evanilla
* Leg IV.1:   [**UPDATE**]
* Leg IV.2:   [**UPDATE**]

**CUFES Sampling:**

* Leg I.2:    L. Vasquez^1^ and S. Morales
