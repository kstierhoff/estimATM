...
if (save.figs) {
  ...
  #   
  #   # Save nasc plot
  #   ggsave(nasc.map.lm, filename = here("Simulation/Figs/fig_nasc_summary_map_LisaMarie.png"), 
  #          width = 3.2, height = 7) 
  #   
  #   save(nasc.map.lm, file = here("Simulation/Output/nasc_plot_fig_LisaMarie.Rdata"))
  # }
  # 
  ...
  #   
  #   # Save nasc plot
  #   ggsave(nasc.map.sd, filename = here("Simulation/Figs/fig_nasc_summary_map_saildrone.png"), 
  #          width = map.width, height = map.height) 
  #   
  #   save(nasc.map.sd, file = here("Simulation/Output/nasc_plot_fig_saildrone.Rdata"))
  # }
}
...
```{r eval=FALSE}
# cluster.sf <- st_as_sf(cluster.pos, coords = c("X","Y"), crs = 3310) 
# 
# test.box <- st_bbox(cluster.sf) %>% 
#   st_as_sfc()
# 
# mapview(test.box) + mapview(cluster.sf)
# 
# nasc.voronoi <- st_voronoi(cluster.sf, test.box) %>% 
#   st_transform(crs = 4326)
# 
# mapview(nasc.voronoi)
```
...
for (i in cps.spp) {
  if (is.null(L.disagg.plots[[i]])) {
    ...
    ggsave(L.disagg.temp, 
           filename = paste(here("Figs/Simulation/fig_L_disagg_"),i,".png", sep = ""))
  }
}  
```  
