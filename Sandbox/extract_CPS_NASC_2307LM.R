...
atm::extract_cps_nasc(
  # Most used options ----------------------------------------------------------
  path.in     = "V:\\SURVEYS\\20230703_LISA-MARIE_SummerCPS\\PROCESSED\\EV\\CSV", # CSV file source                                                                                                 e
  pattern.in  = "_CPS-Final 38 kHz CPS.csv", # CSV file regex
  path.out    = "V:\\SURVEYS\\20230703_LISA-MARIE_SummerCPS\\PROCESSED\\EV\\CSV", # Processed file destination
  suffix.out  = "_nasc_cps.csv",             # Suffix applied to processed CSV files
  path.img    = "V:\\SURVEYS\\20230703_LISA-MARIE_SummerCPS\\PROCESSED\\EV\\Exported_Images", # Location of exported image files, or NULL
